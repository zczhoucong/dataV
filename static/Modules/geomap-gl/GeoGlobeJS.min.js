...
function(a){for(var a=a.split("."),b=window,c=0;c<a.length;c++)b[a[c]]||(b[a[c]]={}),b=b[a[c]]};GeoGlobe.VERSION_NUMBER="GeoGlobeJSAPI 6.4 -- $Version: 1.40.180417 build-20180417 $"})();GeoGlobe.Class=function(){var a=arguments.length,b=arguments[0],c=arguments[a-1],d=typeof c.initialize=="function"?c.initialize:function(){b.prototype.initialize.apply(this,arguments)};a>1?[d,b].concat(Array.prototype.slice.call(arguments).slice(1,a-1),c):d.prototype=c;return d};
...
p=this.readyState,q;h&&j&&(q=function(){p!=b.DONE&&(e(m),m.abort())},window.attachEvent("onunload",q));b.onopen&&b.onopen.apply(this,arguments);arguments.length>4?this._object.open(a,f,j,r,t):arguments.length>3?this._object.open(a,f,j,r):this._object.open(a,f,j);try{this._object.responseType="msxml-document"}catch(s){}this.readyState=b.OPENED;c(this);this._object.onreadystatechange=function(){if(!g||j)m.readyState=m._object.readyState,d(m),m._aborted?m.readyState=b.UNSENT:(m.readyState==b.DONE&&(delete m._data,
e(m),h&&j&&window.detachEvent("onunload",q)),p!=m.readyState&&c(m),p=m.readyState)}};b.prototype.send=function(a){b.onsend&&b.onsend.apply(this,arguments);arguments.length||(a=null);a&&a.nodeType&&(a=window.XMLSerializer?(new window.XMLSerializer).serializeToString(a):a.xml,this._headers["Content-Type"]||this._object.setRequestHeader("Content-Type","application/xml"));this._data=a;this._object.send(this._data);if(g&&!this._async){this.readyState=b.OPENED;for(d(this);this.readyState<b.DONE;)if(this.readyState++,
...
GeoGlobe.Event=mapboxgl.Evented;GeoGlobe.Event.MapMouseEvent=mapboxgl.Event;GeoGlobe.Event.MapTouchEvent=mapboxgl.Event;GeoGlobe.Event.mapDataEvent=mapboxgl.Event;GeoGlobe.Event.mapBoxZoomEvent=mapboxgl.Event;GeoGlobe.Handler=GeoGlobe.Class({initialize:function(){},CLASS_NAME:"GeoGlobe.Handler"});GeoGlobe.Handler.BoxZoomHandler=GeoGlobe.Class(GeoGlobe.Handler,{initialize:function(a){return this.handler=a.boxZoom},CLASS_NAME:"GeoGlobe.Handler.BoxZoomHandler"});
GeoGlobe.Handler.DoubleClickZoomHandler=GeoGlobe.Class(GeoGlobe.Handler,{initialize:function(a){return this.handler=a.doubleClickZoom},CLASS_NAME:"GeoGlobe.Handler.DoubleClickZoomHandler"});GeoGlobe.Handler.DragPanHandler=GeoGlobe.Class(GeoGlobe.Handler,{initialize:function(a){return this.handler=a.dragPan},CLASS_NAME:"GeoGlobe.Handler.DragPanHandler"});
GeoGlobe.Handler.DragRotateHandler=GeoGlobe.Class(GeoGlobe.Handler,{map:null,initialize:function(a){return this.handler=a.dragRotate},isActivate:function(){return this.handler.isActive()},isEnabled:function(){return this.handler.isEnabled()},enable:function(){this.handler.enable()},disable:function(){this.handler.disable()},CLASS_NAME:"GeoGlobe.Handler.DragRotateHandler"});GeoGlobe.Handler.KeyboardHandler=GeoGlobe.Class(GeoGlobe.Handler,{initialize:function(a){return this.handler=a.keyboard},CLASS_NAME:"GeoGlobe.Handler.KeyboardHandler"});
GeoGlobe.Handler.ScrollZoomHandler=GeoGlobe.Class(GeoGlobe.Handler,{initialize:function(a){return this.handler=a.scrollZoom},CLASS_NAME:"GeoGlobe.Handler.ScrollZoomHandler"});GeoGlobe.Handler.TouchZoomRotateHandler=GeoGlobe.Class(GeoGlobe.Handler,{initialize:function(a){return this.handler=a.touchZoomRotate},CLASS_NAME:"GeoGlobe.Handler.TouchZoomRotateHandler"});
...
1])||h.push(n.clone()),!(m===0&&n.equals(d))&&!n.equals(l)&&(j=!0,n.equals(d)||g.push(n),e.push(new GeoGlobe.Geometry.LineString(g)),g=[n.clone()]);j&&(g.push(l.clone()),e.push(new GeoGlobe.Geometry.LineString(g)));if(h.length>0)var q=a.x1<a.x2?1:-1,s=a.y1<a.y2?1:-1,t={lines:e,points:h.sort(function(a,b){return q*a.x-q*b.x||s*a.y-s*b.y})};return t},split:function(a,b){var c=null,d=b&&b.mutual,e,f,g,h;if(a instanceof GeoGlobe.Geometry.LineString){var j=this.getVertices(),l,n,o,r,t,m=[];g=[];for(var p=
0,q=j.length-2;p<=q;++p){l=j[p];n=j[p+1];o={x1:l.x,y1:l.y,x2:n.x,y2:n.y};h=h||[a];d&&m.push(l.clone());for(var s=0;s<h.length;++s)if(r=h[s].splitWithSegment(o,b))if(t=r.lines,t.length>0&&(t.unshift(s,1),Array.prototype.splice.apply(h,t),s+=t.length-2),d)for(var u=0,v=r.points.length;u<v;++u)t=r.points[u],t.equals(l)||(m.push(t),g.push(new GeoGlobe.Geometry.LineString(m)),m=t.equals(n)?[]:[t.clone()])}d&&g.length>0&&m.length>0&&(m.push(n.clone()),g.push(new GeoGlobe.Geometry.LineString(m)))}else c=
...
(g[o.identifier]=o["default"])}for(var r=c.projection||h.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),t=c.units||(r==="EPSG:4326"?"degrees":"m"),m=[],p,q,c=[],n=e.tileMatrixSetLinks,g=function(a){m.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[t]);if(!p||p>a)p=a;if(!q||q<a)q=a},o=0,j=n.length;o<j;o++)if(f=n[o],f.tileMatrixSet===h.identifier){if(f.tileMatrixSetLimits){for(var j={},o=0,s=h.matrixIds.length;o<s;o++)j[h.matrixIds[o].identifier]=h.matrixIds[o];o=
...
v.url=a;u=a.endsWith("?")?GeoGlobe.ProxyHost+a+b:GeoGlobe.ProxyHost+a+"?"+b;v.url_tmpl=u;GeoGlobe.Util.randomStr(10);if(e.bounds)var y=[e.bounds._sw.lng,e.bounds._sw.lat,e.bounds._ne.lng,e.bounds._ne.lat];else e.BoundingBox&&(y=e.BoundingBox[0].bounds.toBBOX());var A=d.tileMatrixSets[e.tileMatrixSetLinks[0].tileMatrixSet].matrixIds[0].identifier;this.GetStyle(l[0],function(a){var b={name:e.identifier,sprite:a.sprite?GeoGlobe.ProxyHost+a.sprite:"",glyphs:a.glyphs?GeoGlobe.ProxyHost+a.glyphs:"",styleName:a.styleName,
srs:r,bbox:y,format:e.formats,zoomoffset:A},c="source_vts_"+GeoGlobe.Util.randomStr(6);v.source_id=c;v.source={type:"vector",tiles:[u]};if(a.styleData)for(var d=0;d<a.styleData.layers.length;d++)a.styleData.layers[d].metadata=b,a.styleData.layers[d].source=c,v.layers[d]=a.styleData.layers[d];else for(d=0;d<a.layers.length;d++)a.layers[d].metadata=b,a.layers[d].source=c,v.layers[d]=a.layers[d]},function(){alert("WMTS\u670d\u52a1\u8bf7\u6c42\u5931\u8d25\uff0c\u8bf7\u68c0\u67e5\u670d\u52a1\u662f\u5426\u6b63\u5e38\u8fd0\u884c\u6216\u8bf7\u6c42\u5730\u5740\u662f\u5426\u6b63\u786e\u3002\n\u8bf7\u6c42\u5730\u5740\uff1a"+
...
paint:{"raster-opacity":1}}):d=new GeoGlobe.Layer.WMS({url:a,layer:d.name,format:b,version:"1.1.1",SRS:g,styles:e,bbox:d.bbox,isTile:!1});return d},createLayer:function(a,b,c){this.url=a;var c=c===void 0||c?!0:!1,d=b&&b.transparent===void 0||b.transparent?!0:!1,e=this.getWMSCapabilities(a);return this.createLayerOption(a,e,{layer:b&&b.layer?b.layer:e.capability.layers[0].name,transparent:d,isTile:c})},createLayers:function(a,b,c){for(var c=c===void 0||c?!0:!1,b=b&&b.transparent===void 0||b.transparent?
...
(c="KVP");var n=[],e=b.params||{};delete b.params;f=0;for(j=d.dimensions.length;f<j;f++){var o=d.dimensions[f];n.push(o.identifier);e.hasOwnProperty(o.identifier)||(e[o.identifier]=o["default"])}for(var n=b.projection||h.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),r=b.units||(n==="EPSG:4326"?"degrees":"m"),t=[],m,p,n=[],o=d.tileMatrixSetLinks,f=function(a){t.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[r]);if(!m||m>a)m=a;if(!p||p<a)p=a},q=0,j=o.length;q<j;q++)if(e=
o[q],e.tileMatrixSet===h.identifier){if(e.tileMatrixSetLimits){for(var j={},q=0,s=h.matrixIds.length;q<s;q++)j[h.matrixIds[q].identifier]=h.matrixIds[q];q=0;for(s=e.tileMatrixSetLimits.length;q<s;q++)o=j[e.tileMatrixSetLimits[q].tileMatrix],n.push(o),f(o.scaleDenominator)}else{q=0;for(s=h.matrixIds.length;q<s;q++)f(h.matrixIds[q].scaleDenominator)}break}if(c==="REST"&&d.resourceUrls){n=[];e=0;for(f=d.resourceUrls.length;e<f;++e)c=d.resourceUrls[e],c.format===g&&c.resourceType==="tile"&&n.push(c.template)}else{j=
...
typeof d!="function"&&b.push(c+"="+d)}return b.join("&")},CLASS_NAME:"GeoGlobe.Format.WMTSUtil"});GeoGlobe.Format.WPSCapabilities=GeoGlobe.Class4OL(GeoGlobe.Format.XML.VersionedOGC,{defaultVersion:"1.0.0",CLASS_NAME:"GeoGlobe.Format.WPSCapabilities"});
...
(function(a,b){a.GeoGlobe.Format.X2JS=b();a.GeoGlobe.Format.X2JS.CLASS_NAME="GeoGlobe.Format.X2JS"})(this,function(){return function(a){function b(a){var b=a.localName;if(b==null)b=a.baseName;if(b==null||b=="")b=a.nodeName;return b}function c(a){return typeof a=="string"?a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&apos;"):a}function d(a,b,c,d){for(var e=0;e<a.length;e++){var f=a[e];if(typeof f==="string"){if(f==d)break}else if(f instanceof
...
"";if(o(b)>0)for(var f in b){var g;if(!(g=n(b,f)))if(g=c!="")g=c===""?f:c+"."+f,g=!(a.jsonPropertiesFilter.length==0||g==""||d(a.jsonPropertiesFilter,b,f,g));if(!g){var h=b[f];g=r(h);if(h==null||h==void 0)e+=j(h,f,g,!0);else if(h instanceof Object)if(h instanceof Array){var p=f,B=c,z="";if(h.length==0)z+=j(h,p,g,!0);else for(g=0;g<h.length;g++)z+=j(h[g],p,r(h[g]),!1),z+=m(h[g],B===""?p:B+"."+p),z+=l(h[g],p);e+=z}else h instanceof Date?(e+=j(h,f,g,!1),e+=h.toISOString(),e+=l(h,f)):o(h)>0||h.__text!=
...
a.getCanvas().style.width;this.container.style.height=a.getCanvas().style.height;this.container.style.position="absolute";a.isIntScrollZoom=!0;this._resize=GeoGlobe.Function.bind(this._resize,this);a.on("resize",this._resize)},_resize:function(){var a=this.map;a.eleContainer.style.width=a.getCanvas().style.width;a.eleContainer.style.height=a.getCanvas().style.height;this.container.style.width=a.getCanvas().style.width;this.container.style.height=a.getCanvas().style.height},getElMap:function(){return this.elmap},
remove:function(){this.map.off("resize",this._resize)},CLASS_NAME:"GeoGlobe.ElementContainer"});
...
this);this._moveend=GeoGlobe.Function.bind(function(a){this.elmap._moving=!1;this._rotating=this._zooming=this.elmap._dragRotating=!1;var c=this.map.getZoom();Math.ceil(c)!==c&&this.map.setZoom(Math.ceil(c));this._iszoomend?(this._iszoomend=!1,c=this.map.getZoom()+1,a=a.target.scrollZoom._pos?a.target.scrollZoom._pos:a.point,a=new maptalks.Point(a.x,a.y),this.elmap._zoomTo(c,a),this.elmap._zooming=!1,this.elmap._getRenderer().onZoomEnd(),this.elmap._fireEvent("zoomend",{from:this.elmap._startZoomVal,
to:c}),this.syncElmapCenter()):(c=this.map.getCenter(),this.elmap.setCenter([c.lng,c.lat]))},this);this._rotatestart=GeoGlobe.Function.bind(function(){this._rotating=!0;this.elmap._dragRotating=!0},this);this._rotate=GeoGlobe.Function.bind(function(){this.syncElmapRotate()},this);this._zoomstart=GeoGlobe.Function.bind(function(a){this._zooming=!0;this.elmap._moving=!1;var c=this.map.getZoom()+1,a=a.target.scrollZoom._pos?a.target.scrollZoom._pos:a.point,d=new maptalks.Point(a.x,a.y);this.origin_lnglat=
this.map.unproject(a);this.elmap.onZoomStart(c,d)},this);this._zoom=GeoGlobe.Function.bind(function(a){var c=this.map.getCenter(),d=this.map.getZoom()+1;if(this.elmap._zoomLevel!==d){var a=a.target.scrollZoom._pos?a.target.scrollZoom._pos:a.point,e=this.map.project(this.origin_lnglat);if(a.x!==Math.round(e.x)||a.y!==Math.round(e.y))this.elmap._zooming=!1;a=new maptalks.Point(a.x,a.y);this.elmap.onZooming(d,a)}d=this.elmap.getCenter();(c.lng-d.x>2||c.lng-d.x<-2)&&this.syncElmapCenter()},this);this._zoomend=
GeoGlobe.Function.bind(function(){this._zooming=!1;this._iszoomend=!0},this);a.on("movestart",this._movestart);a.on("move",this._move);a.on("moveend",this._moveend);a.on("rotatestart",this._rotatestart);a.on("rotate",this._rotate);a.on("zoomstart",this._zoomstart);a.on("zoom",this._zoom);a.on("zoomend",this._zoomend)},_resize:function(){GeoGlobe.ElementContainer.prototype._resize.apply(this,arguments);this.elmap.checkSize()},syncElmapCenter:function(){var a=this.map.getCenter(),a=[a.lng,a.lat];if(!a)return!1;
a=new maptalks.Coordinate(a);this.elmap._setPrjCenter(this.elmap.getProjection().project(a))},syncElmapRotate:function(){var a=this.map;this.elmap&&(a.getBearing(),a.getPitch(),this.elmap.setView({bearing:a.getBearing(),pitch:a.getPitch()}))},_syncElmap:function(){var a=this.map;if(this.elmap){var b=a.getCenter();a.getZoom();a.getBearing();a.getPitch();this.elmap.setView({center:[b.lng,b.lat],zoom:a.getZoom()+1,bearing:a.getBearing(),pitch:a.getPitch()})}},remove:function(){GeoGlobe.ElementContainer.prototype.remove.apply(this,
...
GeoGlobe.Visuals.Three=GeoGlobe.Class4OL(GeoGlobe.Visuals,{map:null,container:null,layers:[],_threebox:null,_raycaster:null,_raycAsix:null,initialize:function(){GeoGlobe.Visuals.prototype.initialize.apply(this,arguments);!window.THREE||!window.Threebox?console.error("\u4f7f\u7528three\u53ef\u89c6\u5316\u56fe\u5c42\u524d\uff0c\u9700\u5f15\u5165threejs\u5e93\uff01"):(this._raycaster=new THREE.Raycaster,this._raycAsix=new THREE.Vector2)},addTo:function(){GeoGlobe.Visuals.prototype.addTo.apply(this,arguments);
this.container.className="geoglobe-three-container";this._threebox=new Threebox(this.map,this.container);this._threebox.setupDefaultLights();this._bindEvent()},render:function(){for(var a=0;a<this.layers.length;a++)this.layers[a].render();this._render()},_render:function(){this._threebox.render()},addLayer:function(a){a.id?this.getLayer(a.id)||this.layers.push(a):console.error("\u56fe\u5c42id\u5c5e\u6027\u4e0d\u80fd\u4e3a\u7a7a\uff01")},removeLayer:function(a){for(var b=[],c=0;c<this.layers.length;c++)a!==
this.layers[c].id&&b.push(this.layers[c]);this.layers=b},_removeInnerLayer:function(a){if(a._meshes&&a._meshes instanceof Array&&a._meshes.length>0)for(var b=0;b<a._meshes.length;b++)for(var c=0;c<this._threebox.world.children.length;c++)if(this._threebox.world.children[c].children.length!==0&&this._threebox.world.children[c].children[0].uuid===a._meshes[b].uuid){this._threebox.world.remove(a._meshes[b].parent);break}},getLayer:function(a){for(var b=0;b<this.layers.length;b++)if(a===this.layers[b].id)return this.layers[b]},
unprojectFromWorld:function(a){var b=new THREE.Matrix4;b.getInverse(this._threebox.world.matrixWorld);return this._threebox.unprojectFromWorld(a.applyMatrix4(b))},_bindEvent:function(){var a=this;this.map.on("click",function(b){a._onClick(b)});this.map.on("mousemove",function(b){a._onMouseMove(b)})},_unbindEvent:function(){for(var a=0;a<this.map._listeners.click.length;a++)this.map._listeners.click[a].name&&this.map._listeners.click[a].name==="THREE_CLICK_EVENT"&&this.map._listeners.click.splice(a,
1);for(a=0;a<this.map._listeners.mousemove.length;a++)this.map._listeners.mousemove[a].name&&this.map._listeners.mousemove[a].name==="THREE_MOUSEMOVE_EVENT"&&this.map._listeners.mousemove.splice(a,1)},_onMouseMove:function(a){var b=this._computerIntersect(a);b.length>0&&this.fire("overlayerhover",{param:{info:this._getSymbolObject(b[0].object),pickedInfos:b,event:a}})},_onClick:function(a){var b=this._computerIntersect(a);b.length>0&&this.fire("overlayerclick",{param:{info:this._getSymbolObject(b[0].object),
pickedInfos:b,event:a}})},_computerIntersect:function(a){this._raycAsix.x=(a.originalEvent.pageX-this.container.offsetLeft)/this.container.offsetWidth*2-1;this._raycAsix.y=-((a.originalEvent.pageY-this.container.offsetTop)/this.container.offsetHeight)*2+1;this._raycaster.setFromCamera(this._raycAsix,this._threebox.camera);return this._raycaster.intersectObjects(this._threebox.world.children,!0)},_getSymbolObject:function(a){return a.userData.attributes?a:this._getSymbolObject(a.parent)}});
...
_mixer:null,initialize:function(a){this.id=a.id?a.id:this.id;this.visible=a.visible?a.visible:this.visible;this.opacity=a.opacity?a.opacity:this.opacity;this.pickable=a.pickable?a.pickable:this.pickable;this.data=a.data?a.data:this.data;this.scale=a.scale?a.scale:this.scale;this.modelURL=a.modelURL?a.modelURL:this.modelURL;this.autoplay=a.autoplay?a.autoplay:this.autoplay;this.getColor=a.getColor?a.getColor:this.getColor;this.getPosition=a.getPosition?a.getPosition:this.getPosition;this.getGeometry=
a.getGeometry?a.getGeometry:this.getGeometry;this.getLoader=a.getLoader?a.getLoader:this.getLoader;this._clock=new THREE.Clock},addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},render:function(){var a=this;a._three._removeInnerLayer(a);a._meshes=[];a.getLoader().load(a.modelURL,function(b){for(var c=0;c<a.data.length;c++){if(b.scene)if(a.autoplay){symbol=b.scene;symbol=a.getGeometry(symbol,a.data[c]);var d=b.animations;if(d&&d.length){for(var e=
new THREE.AnimationMixer(symbol),f=0;f<d.length;f++)e.clipAction(d[f]).play();a._mixer=e}}else symbol=b.scene.clone(),symbol=a.getGeometry(symbol,a.data[c]);else d=a.getGeometry(b.clone(),a.data[c]),e=new THREE.MeshLambertMaterial({color:new THREE.Color(a.getColor(a.data[c])),side:THREE.DoubleSide}),symbol=(new THREE.Mesh(d,e)).clone();symbol.visible=a.visible;symbol.name=(a.id?a.id:"threelayer")+"-"+c;symbol.userData.attributes={OriginalData:a.data[c],Layer:a};d=a.scale?a.scale:1;e=a.getPosition(a.data[c]);
Array.isArray(e)&&(e.length<3&&e.push(0),a._three._threebox.addAtCoordinate(symbol,e,{scaleToLatitude:!0,preScale:d}));a._meshes.push(symbol)}a._three._render();a._animate()},function(a){console.log(a.loaded/a.total*100+"% loaded")},function(a){console.error(a)})},_animate:function(){var a=this;a.autoplay&&(a._mixer.update(a._clock.getDelta()),a._three._render(),requestAnimationFrame(function(){a._animate()}))}});
...
this.drawMode.high.minZoom)&&console.error("option\u4e2d\u7684drawMode\u683c\u5f0f\u4e0d\u6b63\u786e\uff01")},addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},render:function(){this._three._removeInnerLayer(this);this._meshes=[];switch(this._getDrawMode()){case "high":this._highDraw();break;case "middle":this._middleDraw();break;case "low":this._highDraw();break;default:this._highDraw()}this._three._render()},_getDrawMode:function(){var a=
...
this._meshes.push(c)}},_lowDraw:function(){},_createGeometry:function(a){var b=a.geometry.coordinates[0],c=new THREE.Shape,d=this._three._threebox.projectToWorld(b[0]);c.moveTo(d.x,d.y);for(d=1;d<b.length;d++){var e=this._three._threebox.projectToWorld(b[d]);c.lineTo(e.x,e.y)}b={amount:this._three._threebox.distaneToWorld(this.getElevation(a)),bevelEnabled:!1,material:0,extrudeMaterial:1};c=new THREE.ExtrudeGeometry(c,b);if((a=this.getBaseElevation(a))&&a>0)a=this._three._threebox.distaneToWorld(a),
c.translate(0,0,a);return c},_createUvs:function(a){a.faceVertexUvs=[[]];for(var b=[new THREE.Vector2(1,0),new THREE.Vector2(0,0),new THREE.Vector2(0,1),new THREE.Vector2(1,1)],c=a.faces.length,d=0;d<c;d+=2)if(a.faces[d].normal.z==0)a.faceVertexUvs[0][d]=[b[1],b[0],b[2]],a.faceVertexUvs[0][d+1]=[b[0],b[3],b[2]];else{var e=a.vertices[a.faces[d].a],f=a.vertices[a.faces[d].b],g=a.vertices[a.faces[d].c];a.faceVertexUvs[0][d]=[new THREE.Vector2(e.x,e.y),new THREE.Vector2(f.x,f.y),new THREE.Vector2(g.x,
g.y)];e=a.vertices[a.faces[d+1].a];f=a.vertices[a.faces[d+1].b];g=a.vertices[a.faces[d+1].c];a.faceVertexUvs[0][d+1]=[new THREE.Vector2(e.x,e.y),new THREE.Vector2(f.x,f.y),new THREE.Vector2(g.x,g.y)]}return a},_createTexture:function(a){var b=this,c=b._getTextureCacheByURL(a);c?c=c.clone():(c=(new THREE.TextureLoader).load(a,function(){b._three._render()}),b._addTextureInToCache({key:a,value:c}));return c},_getTextureCacheByURL:function(a){if(a)for(;0<this._textureCache.length;)return this._textureCache[0].key===
a&&this._textureCache[0].value.image?this._textureCache[0].value:null;else return null},_addTextureInToCache:function(a){for(var b=!1,c=0;c<this._textureCache.length;c++)if(this._textureCache[c].key===a.key){b=!0;break}b||this._textureCache.push(a)}});
GeoGlobe.Visuals.EchartsGL=GeoGlobe.Class4OL(GeoGlobe.Visuals,{map:null,container:null,layers:[],visualMap:null,mapbox3D:{boxHeight:10,boxWidth:100,altitudeScale:1},_echartsgl:null,initialize:function(a){GeoGlobe.Visuals.prototype.initialize.apply(this,arguments);window.echarts?(this.visualMap=a.visualMap?a.visualMap:this.visualMap,this.mapbox3D=a.mapbox3D?a.mapbox3D:this.mapbox3D,console.warn("EchartsGL 1.1 \u6682\u672a\u652f\u6301\u9f20\u6807\u62fe\u53d6\u4e8b\u4ef6\uff01")):console.error("\u4f7f\u7528EchartsGL\u53ef\u89c6\u5316\u56fe\u5c42\u524d\uff0c\u9700\u5f15\u5165echarts\u548cechartsgl\u5e93\uff01")},
addTo:function(){GeoGlobe.Visuals.prototype.addTo.apply(this,arguments);this.container.className="geoglobe-echartsgl-container";this._echartsgl=echarts.init(this.container);this._echartsgl._mapbox=this.map;this.mapbox3D.center=this.map.getCenter().toArray();this.mapbox3D.zoom=this.map.getZoom();this.mapbox3D.pitch=this.map.getPitch();this.mapbox3D.bearing=this.map.getBearing();this._bindEvent()},render:function(){var a={};this.visualMap&&(a.visualMap=this.visualMap);a.mapbox3D=this.mapbox3D;a.series=
[];a.units=this.map.units;a.topTileExtent=this.map._tileExtent;for(var b=0;b<this.layers.length;b++)a.series.push(this.layers[b].getRenderOption());this._echartsgl.setOption(a)},addLayer:function(a){a.id?this.getLayer(a.id)||this.layers.push(a):console.error("\u56fe\u5c42id\u5c5e\u6027\u4e0d\u80fd\u4e3a\u7a7a\uff01")},removeLayer:function(a){for(var b=[],c=0;c<this.layers.length;c++)a!==this.layers[c].id&&b.push(this.layers[c]);this.layers=b},getLayer:function(a){for(var b=0;b<this.layers.length;b++)if(a===
...
this.map._listeners.mousemove[a].name==="CUSTOM_MOUSEMOVE_EVENT"&&this.map._listeners.mousemove.splice(a,1);for(a=0;a<this.map._listeners.resize.length;a++)this.map._listeners.resize[a].name&&this.map._listeners.resize[a].name==="CUSTOM_RESIZE_EVENT"&&this.map._listeners.resize.splice(a,1)},_onClick:function(a){for(var b=0;b<this.layers.length;b++)this.layers[b].click&&this.layers[b].click(a)},_onMouseMove:function(a){for(var b=0;b<this.layers.length;b++)this.layers[b].mouseMove&&this.layers[b].mouseMove(a)},
_onResize:function(){for(var a=0;a<this.layers.length;a++)this.layers[a].resize()}});
GeoGlobe.Visuals.Custom.Bubble=GeoGlobe.Class4OL({_parent:null,canvas:[],cacheCanvas:[],canvasContext:[],cacheCanvasContext:[],MarkPoint:null,markPoints:[],initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this._init_RendererOptions();this._initMarkPoint();this._initMarkPointExtra();this.setData(this.data)},_init_RendererOptions:function(){this._rendererOptions=GeoGlobe.Util.deepExtend({},{markPoint:{hoverable:!0,clickable:!0,symbol:"bubble",symbolMinSize:20,symbolMaxSize:40,symbolNumber:Number.MAX_VALUE,
symbolValueRangeScale:1,symbolSrc:"",effect:{show:!0,scaleSize:2,period:10},itemStyle:{color:"rgba(255,0,0,0.7)",shadowColor:"#000",shadowBlur:0,shadowOffsetX:0,shadowOffsetY:0},label:{show:!0,color:"#fff",align:"center",baseline:"middle",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}},tooltip:{show:!0,backgroundColor:"rgba(0,0,0,0.7)",borderColor:"#333",borderRadius:0,borderWidth:0,padding:5,textStyle:{color:"#fff",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}}},
this.rendererOptions)},_initMarkPoint:function(){var a=this,b=this._rendererOptions.markPoint,c=b.effect,d=b.itemStyle,e=b.label;this.MarkPoint=function(c,e,h,j,l,n,o){this.index=c;this.name=e;this.value=h;this.lon=j;this.lat=l;this.time=n;this.attributes=o;this.init();this.weight=(this.value-a.minValue)/(a.maxValue-a.minValue);if(isNaN(this.weight))this.weight=1;if(this.weight>1)this.weight=1;if(this.weight<0)this.weight=0;this.size=b.symbolMinSize+(b.symbolMaxSize-b.symbolMinSize)*this.weight;this.radius=
this.size/2;this.color=GeoGlobe.Util.getType(d.color)==="object"?"rgba("+a.gradientImageData[~~(this.weight*255+0.5)*4]+","+a.gradientImageData[~~(this.weight*255+0.5)*4+1]+","+a.gradientImageData[~~(this.weight*255+0.5)*4+2]+","+a.gradientImageData[3]/255+")":d.color;this.rgbColor=GeoGlobe.Util.getRgbColor(this.color);this.tmpColor=this.color;this.alpha=this.color.indexOf("a(")!==-1?+this.color.split(",")[3].split(")")[0]:1;switch(b.symbol){case "fire":this.fires=[];for(c=0;c<150;c++)this.fires.push(new a.Fire(this.size));
break;case "water":this.waveLength=0.1;this.waveSize=this.size*0.8;this.attenuations=[3,2];this.noises=[0.6*(this.waveSize/2-4),0.3*(this.waveSize/2-4)];this.Fs=[10,10];break;case "heatmap":this.scale=this.size/b.symbolMaxSize;break;case "sprite":this.scale=this.size/b.symbolMaxSize,this.factor=1}};this.MarkPoint.prototype.init=function(){switch(b.symbol){case "bubble":case "ellipse":this.energy=c.show?Math.random()*c.scaleSize:c.scaleSize;this.increment=Math.max(0.1*c.scaleSize/c.period+Math.random()*
(Math.random()>0.5?1:-1)*0.002,0.001);break;case "circle":this.energy=[0,1/3,2/3];this.increment=Math.max(0.1*c.scaleSize/c.period+Math.random()*(Math.random()>0.5?1:-1)*0.002,0.001);break;case "ring":this.energy=[0,0.25*c.scaleSize,0.5*c.scaleSize,0.75*c.scaleSize];this.increment=Math.max(0.1*c.scaleSize/c.period+Math.random()*(Math.random()>0.5?1:-1)*0.002,0.001);break;case "water":this.energy=0;this.increment=0.1+Math.random()*(Math.random()>0.5?1:-1)*0.02;break;case "sprite":this.energy=c.show?
Math.random()*c.scaleSize:c.scaleSize,this.increment=Math.max(0.1*c.scaleSize/c.period+Math.random()*(Math.random()>0.5?1:-1)*0.002,0.001)}};this.MarkPoint.prototype.updateXY=function(){var c=a._parent.map.project([this.lon,this.lat]);this.x=c.x;this.y=c.y;if(b.symbol==="fire")for(c=0;c<this.fires.length;c++)this.fires[c].x=this.x,this.fires[c].y=this.y;this.visible=!0};this.MarkPoint.prototype.update=function(){var d;switch(b.symbol){case "bubble":case "ellipse":this.energy+=this.increment;if(this.energy>
c.scaleSize)this.energy=0;break;case "circle":for(d=0;d<3;d++)this.energy[d]+=this.increment,this.energy[d]>1&&(this.energy[d]=0);break;case "ring":for(d=0;d<4;d++)this.energy[d]+=this.increment,this.energy[d]>c.scaleSize&&(this.energy[d]=0);break;case "fire":var e;for(d=0;d<this.fires.length;d++)e=this.fires[d],e.x+=e.speedX,e.y+=e.speedY,e.opacity-=e.increment,e.radius++,e.opacity<0&&(this.fires[d]=new a.Fire(this.size,this.x,this.y));break;case "water":this.energy=(this.energy+this.increment)%
(Math.PI*64);break;case "sprite":if(this.energy<=0.15)this.factor=1;else if(this.energy>=c.scaleSize)this.factor=-1;this.energy+=this.factor*this.increment}};this.MarkPoint.prototype.isPointInPath=function(c,d,h){c.beginPath();switch(b.symbol){case "bubble":case "circle":case "ring":case "round":case "water":case "ellipse":case "heatmap":case "sprite":c.arc(this.x,this.y,this.radius,0,Math.PI*2,!0);break;case "pin":c.moveTo(this.x-0.5,this.y);c.quadraticCurveTo(this.x,this.y-this.radius/2,this.x-
...
c:this.value},b.formatter).split("<br/>"),o=n.length,r=0;r<o;r++){var t=c.measureText(n[r]).width;t>j&&(j=t);c.fillText(n[r],this.x,this.y-((o-1)/2-r)*(this.radius*2+5))}else j=c.measureText("\uffe5"+this.value).width;c.rect(this.x-j/2,this.y-l/2,j,l)}break;case "fire":c.rect(this.x-this.size/2,this.y-this.size/2,this.size,this.size)}if(c.isPointInPath(d,h))a.hoveredMarkPoint=this};this.MarkPoint.prototype.draw1=function(f){a.hoveredMarkPoint===this?(this.radius=this.size/2*1.1,this.color=GeoGlobe.Util.getShadeColor(this.tmpColor,
20)):(this.radius=this.size/2,this.color=this.tmpColor);this.rgbColor=GeoGlobe.Util.getRgbColor(this.color);f.shadowColor=d.shadowColor;f.shadowBlur=d.shadowBlur;f.shadowOffsetX=d.shadowOffsetX;f.shadowOffsetY=d.shadowOffsetY;switch(b.symbol){case "bubble":if(a.hoveredMarkPoint===this)f.beginPath(),f.arc(this.x,this.y,this.radius*c.scaleSize/2,0,Math.PI*2,!0),f.lineWidth=~~(this.radius/5+0.5)<2?2:~~(this.radius/5+0.5),f.strokeStyle=this.color,f.stroke();break;case "circle":case "round":f.beginPath();
f.arc(this.x,this.y,this.radius,0,Math.PI*2,!0);f.fillStyle=this.color;f.fill();break;case "pin":f.beginPath();f.moveTo(this.x+this.radius/3,this.y);f.quadraticCurveTo(this.x+this.radius/3,this.y+this.radius/10,this.x,this.y+this.radius/10);f.quadraticCurveTo(this.x-this.radius/3,this.y+this.radius/10,this.x-this.radius/3,this.y);f.quadraticCurveTo(this.x-this.radius/3,this.y-this.radius/10,this.x,this.y-this.radius/10);f.quadraticCurveTo(this.x+this.radius/3,this.y-this.radius/10,this.x+this.radius/
3,this.y);f.fillStyle="rgba(0,0,0,0.3)";f.fill();f.beginPath();f.moveTo(this.x+this.radius*2/3,this.y);f.quadraticCurveTo(this.x+this.radius*2/3,this.y+this.radius/6,this.x,this.y+this.radius/6);f.quadraticCurveTo(this.x-this.radius*2/3,this.y+this.radius/6,this.x-this.radius*2/3,this.y);f.quadraticCurveTo(this.x-this.radius*2/3,this.y-this.radius/6,this.x,this.y-this.radius/6);f.quadraticCurveTo(this.x+this.radius*2/3,this.y-this.radius/6,this.x+this.radius*2/3,this.y);f.fillStyle="rgba(0,0,0,0.2)";
f.fill();f.beginPath();f.moveTo(this.x-0.5,this.y);f.quadraticCurveTo(this.x,this.y-this.radius/2,this.x-this.radius*Math.sin(Math.PI/3),this.y-this.radius-this.radius*Math.sin(Math.PI/6));f.arc(this.x,this.y-this.radius*2,this.radius,0,Math.PI*5/6,!0);f.arc(this.x,this.y-this.radius*2,this.radius,0,Math.PI/6,!1);f.quadraticCurveTo(this.x,this.y-this.radius/2,this.x+0.5,this.y);f.fillStyle=this.color;f.fill();break;case "rmb":f.font=e.fontStyle+" "+e.fontWeight+" "+this.radius*2+"px "+e.fontFamily;
f.textAlign="center";f.textBaseline="middle";f.fillStyle=this.color;if(GeoGlobe.String.isNumeric(this.value))if(b.formatter)for(var g=GeoGlobe.Util.getFormattedString({a:this.name,b:"\u7edf\u8ba1\u6570",c:this.value},b.formatter).split("<br/>"),h=g.length,j=0;j<h;j++)f.fillText(g[j],this.x,this.y-((h-1)/2-j)*(this.radius*2+5));else f.fillText("\uffe5"+this.value,this.x,this.y);break;case "water":g=f.createRadialGradient(this.x,this.y,0,this.x,this.y,this.radius);g.addColorStop(0.8,"rgba(255,255,255,0)");
g.addColorStop(1,"rgba(255,255,255,1)");f.beginPath();f.arc(this.x,this.y,this.radius,0,Math.PI*2,!1);f.fillStyle=g;f.fill();break;case "heatmap":f.save();f.translate(this.x,this.y);f.scale(this.scale,this.scale);f.drawImage(a.markPointCacheCanvas,-a.markPointCacheCanvasSize/2,-a.markPointCacheCanvasSize/2);f.restore();break;case "icon":f.save(),f.translate(this.x,this.y),f.rotate(Math.PI/180*(this.attributes.azimuth-a._parent.map.getBearing())),f.drawImage(a.markPointCacheImage,-this.size/2,-this.size/
2,this.size,this.size),f.restore()}switch(b.symbol){case "bubble":case "circle":case "round":case "water":case "ellipse":if(e.show)f.font=e.fontStyle+" "+e.fontWeight+" "+e.fontSize+"px "+e.fontFamily,f.textAlign=e.align,f.textBaseline=e.baseline,f.fillStyle=e.color,f.fillText(this.value,this.x,this.y);break;case "pin":if(e.show)f.beginPath(),f.arc(this.x,this.y-this.radius*2,this.radius/3,0,Math.PI*2,!0),f.shadowBlur=0,f.shadowOffsetX=0,f.shadowOffsetY=0,f.fillStyle=e.color,f.fill()}};this.MarkPoint.prototype.draw2=
function(d){var g;switch(b.symbol){case "bubble":d.beginPath();d.arc(this.x,this.y,this.radius*this.energy,0,Math.PI*2,!0);d.strokeStyle=this.color;d.stroke();break;case "circle":for(g=0;g<3;)d.beginPath(),d.arc(this.x,this.y,this.radius+this.radius*(c.scaleSize-1)*this.energy[g],0,Math.PI*2,!0),d.strokeStyle="rgba"+this.rgbColor.slice(3).split(")")[0]+","+(1-this.energy[g])*this.alpha+")",d.stroke(),g++;break;case "ring":for(g=0;g<4;)d.beginPath(),d.arc(this.x,this.y,this.radius*this.energy[g],0,
Math.PI*2,!0),d.fillStyle="rgba"+this.rgbColor.slice(3).split(")")[0]+","+Math.max(1-this.energy[g]/c.scaleSize,0)*this.alpha+")",d.fill(),g++;if(e.show)d.font=e.fontStyle+" "+e.fontWeight+" "+e.fontSize+"px "+e.fontFamily,d.textAlign=e.align,d.textBaseline=e.baseline,d.fillStyle=e.color?e.color:this.color,d.fillText(this.value,this.x,this.y);break;case "fire":var h,j;for(g=0;g<this.fires.length;g++)h=this.fires[g],j=d.createRadialGradient(h.x,h.y,0,h.x,h.y,h.radius),j.addColorStop(0,"rgba"+this.rgbColor.slice(3).split(")")[0]+
","+h.opacity+")"),j.addColorStop(0.5,"rgba"+this.rgbColor.slice(3).split(")")[0]+","+h.opacity+")"),j.addColorStop(1,"rgba"+this.rgbColor.slice(3).split(")")[0]+", 0)"),d.beginPath(),d.arc(h.x,h.y,h.radius,0,Math.PI*2,!1),d.fillStyle=j,d.globalAlpha=this.alpha,d.fill();break;case "water":h=this.x-this.radius*0.8;j=this.y;var l,n;d.beginPath();d.moveTo(h,j);for(g=-this.waveLength;g<=this.waveLength;g+=0.01)g=parseFloat(parseFloat(g).toFixed(2)),l=h+this.waveSize*((g+this.waveLength)/(this.waveLength*
2)),n=j+this.noises[0]*Math.pow(Math.sin(g*10*this.attenuations[0]),1)*Math.sin(this.Fs[0]*g-this.energy),d.lineTo(l,n);d.arc(this.x,this.y,this.radius*0.8,0,Math.PI,!1);d.fillStyle=GeoGlobe.Util.getShadeColor(this.color,-10);d.globalAlpha=this.alpha;d.fill();d.beginPath();d.moveTo(h,j);for(g=-this.waveLength;g<=this.waveLength;g+=0.01)g=parseFloat(parseFloat(g).toFixed(2)),l=h+this.waveSize*((g+this.waveLength)/(this.waveLength*2)),n=j+this.noises[1]*Math.pow(Math.sin(g*10*this.attenuations[1]),
1)*Math.sin(this.Fs[1]*g-this.energy),d.lineTo(l,n);d.arc(this.x,this.y,this.radius*0.8,0,Math.PI,!1);d.fillStyle=this.color;d.globalAlpha=1;d.fill();break;case "ellipse":j=d.createRadialGradient(this.x,this.y,this.radius*this.energy,this.x,this.y,0);j.addColorStop(0.7,"rgba"+this.rgbColor.slice(3).split(")")[0]+", 0.5)");j.addColorStop(0.3,"rgba"+this.rgbColor.slice(3).split(")")[0]+", 1)");j.addColorStop(0.2,"rgba"+this.rgbColor.slice(3).split(")")[0]+", 1)");j.addColorStop(0,"rgba"+this.rgbColor.slice(3).split(")")[0]+
", 0)");d.beginPath();d.arc(this.x,this.y,this.radius*this.energy,0,Math.PI*2,!1);d.fillStyle=j;d.globalAlpha=(1-this.energy/c.scaleSize)*this.alpha;d.fill();break;case "sprite":d.save(),d.translate(this.x,this.y),d.scale(this.scale*this.energy,this.scale*this.energy),d.drawImage(a.markPointCacheCanvas,-a.markPointCacheCanvasSize/2,-a.markPointCacheCanvasSize/2),d.restore()}c.show&&this.update()}},_initMarkPointExtra:function(){var a=this;if(GeoGlobe.Util.getType(this._rendererOptions.markPoint.itemStyle.color)===
"object")this.gradientImageData=GeoGlobe.Util.getGradientImageData(this._rendererOptions.markPoint.itemStyle.color);switch(this._rendererOptions.markPoint.symbol){case "fire":if(!this.Fire)this.Fire=function(a,b,c){this.x=b;this.y=c;this.speedX=-1+Math.random()*2;this.speedY=-5+Math.random()*5;this.radius=0.5+Math.random();this.increment=(1+Math.random())/a;this.opacity=1};break;case "heatmap":this.markPointCacheCanvasSize=this._rendererOptions.markPoint.symbolMaxSize;this.markPointCacheCanvas=document.createElement("canvas");
...
this.markPointCacheCanvasContext.fillStyle=c;this.markPointCacheCanvasContext.fill();if(!this.makeItHot)this.makeItHot=function(a,b,c,g,h){for(var g=a.getImageData(b,c,g,h),h=g.data,j=this.gradientImageData,l=h.length/4,n,o,r;l--;)n=l*4+3,o=h[n],r=o*4,o&&(h[n-3]=j[r],h[n-2]=j[r+1],h[n-1]=j[r+2]);a.putImageData(g,b,c)};break;case "icon":this.markPointCacheImage=new Image;this.markPointCacheImage.src=this._rendererOptions.markPoint.symbolSrc;this.markPointCacheImage.onload=function(){a.draw1()};break;
case "sprite":this.markPointCacheCanvasSize=this._rendererOptions.markPoint.symbolMaxSize,this.markPointCacheCanvas=document.createElement("canvas"),this.markPointCacheCanvas.width=this.markPointCacheCanvasSize,this.markPointCacheCanvas.height=this.markPointCacheCanvasSize,this.markPointCacheCanvasContext=this.markPointCacheCanvas.getContext("2d"),b=GeoGlobe.Util.getRgbColor(this._rendererOptions.markPoint.itemStyle.color),c=this.markPointCacheCanvasContext.createRadialGradient(this.markPointCacheCanvasSize/
2,this.markPointCacheCanvasSize/2,0,this.markPointCacheCanvasSize/2,this.markPointCacheCanvasSize/2,this.markPointCacheCanvasSize/2),c.addColorStop(0.15,this._rendererOptions.markPoint.itemStyle.color),c.addColorStop(0.5,"rgba"+b.slice(3).split(")")[0]+",0.15)"),c.addColorStop(1,"rgba"+b.slice(3).split(")")[0]+",0)"),this.markPointCacheCanvasContext.fillStyle=c,this.markPointCacheCanvasContext.fillRect(0,0,this.markPointCacheCanvasSize,this.markPointCacheCanvasSize)}},_initCanvas:function(){this.canvas=
[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.canvasContext.push(this.canvas[1].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.cacheCanvasContext.push(this.cacheCanvas[1].getContext("2d"));
this.canvas[0].width=this.canvas[1].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.height=this._parent.map.transform.height;this.canvas[0].style.position="absolute";this.canvas[1].style.position="absolute";this._parent.container.appendChild(this.canvas[0]);this._parent.container.appendChild(this.canvas[1]);this.setVisible(this.visibility)},_initTooltip:function(){if((this._rendererOptions.markPoint.hoverable||
this._rendererOptions.markPoint.clickable)&&this._rendererOptions.tooltip.show)this.tooltipDiv=this.tooltipDiv||this._parent.container.appendChild(document.createElement("div")),this.tooltipDiv.style.position="absolute",this.tooltipDiv.style.display="none",this.tooltipDiv.style.zIndex=999,this.tooltipDiv.style.color=this._rendererOptions.tooltip.textStyle.color,this.tooltipDiv.style.padding=this._rendererOptions.tooltip.padding+"px",this.tooltipDiv.style.font=this._rendererOptions.tooltip.textStyle.fontStyle+
...
this.tooltipDiv.style["border-radius"]=this._rendererOptions.tooltip.borderRadius+"px",this.tooltipDiv.style["border-style"]="solid",this.tooltipDiv.style["white-space"]="pre-wrap",this.tooltipDiv.style.transition="left 0.4s, top 0.4s"},render:function(){this._initCanvas();this._initTooltip();var a=this;(function c(){requestAnimationFrame(c);if(a.dragdrawing===!1&&a._parent.flatdragging){var d=a._parent.lastCenter,e=a._parent.map.project([d.lng,d.lat]),d=e.x-a.width/2,e=e.y-a.height/2;a.canvas[0].style.left=
d+"px";a.canvas[0].style.top=e+"px";a.canvas[1].style.left=d+"px";a.canvas[1].style.top=e+"px"}else if(a.dragdrawing===!1&&a._parent.moving)a.clearCanvas();else{if(a._parent.moving||a.RELOADED||a.RESIZE)a.updateXY(),a.draw1(),!a._rendererOptions.markPoint.effect.show&&a.draw2(),a.RELOADED&&(a.RELOADED=!1),a.RESIZE&&(a.RESIZE=!1);(a._rendererOptions.markPoint.symbol==="bubble"||a._rendererOptions.markPoint.symbol==="circle"||a._rendererOptions.markPoint.symbol==="ring"||a._rendererOptions.markPoint.symbol===
"water"||a._rendererOptions.markPoint.symbol==="fire"||a._rendererOptions.markPoint.symbol==="ellipse"||a._rendererOptions.markPoint.symbol==="sprite")&&a._rendererOptions.markPoint.effect.show&&a.draw2()}})();this.RENDERED=!0},click:function(a){this._rendererOptions.markPoint.clickable&&this.hoveredMarkPoint&&this._parent.fire("overlayerclick",{layer:this,feature:this.hoveredMarkPoint,event:a})},mouseMove:function(a){this._rendererOptions.markPoint.hoverable&&this.visibility&&this.markPoints.length>
0&&!this._parent.map.moving&&(this.hover(a.point.x,a.point.y),this.hoveredMarkPoint&&this._parent.fire("overlayerhover",{layer:this,feature:this.hoveredMarkPoint,event:a}))},resize:function(){this.canvas[0].width=this.canvas[1].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.height=this._parent.map.transform.height;this.RESIZE=!0},redraw:function(){if(this.RENDERED){this.clearCanvas();
this.resetCanvas();console.time("\u8ba1\u7b97\u5c4f\u5e55\u5750\u6807");this.updateXY();console.timeEnd("\u8ba1\u7b97\u5c4f\u5e55\u5750\u6807");console.time("\u7ed8\u5236");this.draw1();var a=this._rendererOptions.markPoint.symbol;(a==="bubble"||a==="circle"||a==="ring"||a==="water"||a==="fire"||a==="ellipse"||a==="sprite")&&this.draw2();console.timeEnd("\u7ed8\u5236")}},updateXY:function(){for(var a=this.markPoints.length<this._rendererOptions.markPoint.symbolNumber?this.markPoints.length:this._rendererOptions.markPoint.symbolNumber;a--;)this.markPoints[a].updateXY()},
draw1:function(){this.cacheCanvas[0].width=this.width;if(this._rendererOptions.markPoint.symbol==="round")this.cacheCanvasContext[0].globalCompositeOperation="lighter";for(var a=this.markPoints.length<this._rendererOptions.markPoint.symbolNumber?this.markPoints.length:this._rendererOptions.markPoint.symbolNumber;a--;)this.markPoints[a].visible&&this.markPoints[a].draw1(this.cacheCanvasContext[0]);this._rendererOptions.markPoint.symbol==="heatmap"&&this.makeItHot(this.cacheCanvasContext[0],0,0,this.width,
this.height);this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},draw2:function(){this._rendererOptions.markPoint.symbol==="bubble"?document.createElement("canvas").getContext?(this.cacheCanvasContext[1].globalCompositeOperation="destination-out",this.cacheCanvasContext[1].fillStyle="rgba(0, 0, 0, 0.1)",this.cacheCanvasContext[1].fillRect(0,0,this.width,this.height),this.cacheCanvasContext[1].globalCompositeOperation="source-over"):this.cacheCanvas[1].width=this.width:
this._rendererOptions.markPoint.symbol==="ring"||this._rendererOptions.markPoint.symbol==="fire"||this._rendererOptions.markPoint.symbol==="sprite"?(this.cacheCanvas[1].width=this.width,this.cacheCanvasContext[1].globalCompositeOperation="lighter"):this.cacheCanvas[1].width=this.width;this.cacheCanvasContext[1].save();for(var a=this.markPoints.length<this._rendererOptions.markPoint.symbolNumber?this.markPoints.length:this._rendererOptions.markPoint.symbolNumber;a--;)this.markPoints[a].visible&&this.markPoints[a].draw2(this.cacheCanvasContext[1]);
this.canvas[1].width=this.width;this.canvasContext[1].drawImage(this.cacheCanvas[1],0,0)},resetCanvas:function(){this.canvas[0].style.left="";this.canvas[0].style.top="";this.canvas[1].style.left="";this.canvas[1].style.top=""},clearCanvas:function(){this.canvas[0].width=this.width;this.canvas[1].width=this.width;this.cacheCanvas[0].width=this.width;this.cacheCanvas[1].width=this.width},hover:function(a,b){this.lastHoveredMarkPoint=this.hoveredMarkPoint?GeoGlobe.Util.clone(this.hoveredMarkPoint):
null;this.hoveredMarkPoint=null;for(var c=0,d=this.markPoints.length<this._rendererOptions.markPoint.symbolNumber?this.markPoints.length:this._rendererOptions.markPoint.symbolNumber;c<d;c++)!this.hoveredMarkPoint&&this.markPoints[c].isPointInPath(this.cacheCanvasContext[0],a,b);this.draw1();this.hoveredMarkPoint?(this.canvas[1].style.cursor="pointer",this.showTooltip(this.hoveredMarkPoint.name,a,b)):(this.canvas[1].style.cursor="default",this.hideTooltip())},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=
a,this.tooltipDiv.style.top=c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display="none"},addTo:function(a){this._parent=a;this._parent.addLayer(this)},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=this.canvas[1].style.display=a?"block":"none"},setData:function(a){this.data=a;this.minValue=Number.MAX_VALUE;this.maxValue=Number.MIN_VALUE;for(var b=0;b<a.length;b++){if(a[b].properties.value<
this.minValue)this.minValue=a[b].properties.value;if(a[b].properties.value>this.maxValue)this.maxValue=a[b].properties.value}this.maxValue/=this._rendererOptions.markPoint.symbolValueRangeScale;for(var c=[],b=0;b<a.length;b++)c.push(new this.MarkPoint(b,a[b].properties.name,a[b].properties.value,a[b].geometry.coordinates[0],a[b].geometry.coordinates[1],a[b].properties.time,a[b].properties));this.hoveredMarkPoint=null;this.markPoints=c;this.RELOADED=!0}});
GeoGlobe.Visuals.Custom.Migration=GeoGlobe.Class4OL({_parent:null,canvas:[],cacheCanvas:[],canvasContext:[],cacheCanvasContext:[],MarkPoint:null,MarkLine:null,markPoints:[],markLines:[],initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this._init_RendererOptions();this._initMarkPoint();this._initMarkLine();this.setData(this.data)},_init_RendererOptions:function(){this._rendererOptions=GeoGlobe.Util.deepExtend({},{markLine:{hoverable:!0,curveness:0.6,effect:{color:"#fff",scaleSize:3,
period:30},itemStyle:{color:null,width:1}},markPoint:{hoverable:!0,symbol:"emptyCircle",symbolMinSize:20,symbolMaxSize:40,effect:{scaleSize:2,period:30},itemStyle:{color:"rgba(255,0,0,0.5)",shadowColor:"#000000",shadowBlur:0,shadowOffsetX:0,shadowOffsetY:0},label:{show:!0,color:"#fff",align:"center",baseline:"middle",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}},tooltip:{show:!0,backgroundColor:"rgba(0,0,0,0.7)",borderColor:"#333",borderRadius:0,borderWidth:0,padding:5,textStyle:{color:"#fff",
fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}}},this.rendererOptions)},_initMarkPoint:function(){var a=this,b=this._rendererOptions.markPoint.symbol,c=this._rendererOptions.markPoint.symbolMinSize,d=this._rendererOptions.markPoint.symbolMaxSize,e=this._rendererOptions.markPoint.effect,f=this._rendererOptions.markPoint.itemStyle;if(typeof f.color==="object")var g=GeoGlobe.Util.getGradientImageData(f.color);var h=this._rendererOptions.markPoint.label;this.MarkPoint=function(b,
e,h,o,r){this.index=b;this.name=e;this.value=h;this.lon=o;this.lat=r;this.init();this.weight=(this.value-a.minValue)/(a.maxValue-a.minValue);if(isNaN(this.weight))this.weight=1;if(this.weight>1)this.weight=1;if(this.weight<0)this.weight=0;this.size=c+(d-c)*this.weight;this.radius=this.size/2;this.color=typeof f.color==="object"?"rgba("+g[parseInt(this.weight*255,10)*4]+","+g[parseInt(this.weight*255,10)*4+1]+","+g[parseInt(this.weight*255,10)*4+2]+","+g[3]/255+")":f.color;this.rgbColor=GeoGlobe.Util.getRgbColor(this.color);
this.tmpColor=this.color};this.MarkPoint.prototype.init=function(){switch(b){case "circle":this.energy=[0,1/3,2/3];break;case "ring":this.energy=[0,0.25*e.scaleSize,0.5*e.scaleSize,0.75*e.scaleSize];break;case "emptyCircle":this.energy=0}this.increment=Math.max(0.1*e.scaleSize/e.period+Math.random()*(Math.random()>0.5?1:-1)*0.002,0.001)};this.MarkPoint.prototype.updateXY=function(){var b=a._parent.map.project([this.lon,this.lat]);this.x=b.x;this.y=b.y};this.MarkPoint.prototype.update=function(){var a;
switch(b){case "circle":for(a=0;a<3;a++)this.energy[a]<1?this.energy[a]+=this.increment:this.energy[a]=0;break;case "ring":for(a=0;a<4;a++)this.energy[a]<e.scaleSize?this.energy[a]+=this.increment:this.energy[a]=0;break;case "emptyCircle":this.energy<e.scaleSize?this.energy+=this.increment:this.energy=0}};this.MarkPoint.prototype.isPointInPath=function(b,c,d){b.beginPath();b.arc(this.x,this.y,this.size/2,0,Math.PI*2,!0);if(b.isPointInPath(c,d))a.hoveredMarkPoint=this};this.MarkPoint.prototype.draw1=
function(c){a.hoveredMarkPoint===this?(this.radius=this.size/2*1.1,this.color=GeoGlobe.Util.getShadeColor(this.tmpColor,20)):(this.radius=this.size/2,this.color=this.tmpColor);this.rgbColor=GeoGlobe.Util.getRgbColor(this.color);c.shadowColor=f.shadowColor;c.shadowBlur=f.shadowBlur;c.shadowOffsetX=f.shadowOffsetX;c.shadowOffsetY=f.shadowOffsetY;switch(b){case "circle":c.beginPath();c.arc(this.x,this.y,this.radius,0,Math.PI*2,!0);c.fillStyle=this.color;c.fill();break;case "emptyCircle":if(a.hoveredMarkPoint===
this)c.beginPath(),c.arc(this.x,this.y,this.radius*e.scaleSize/2,0,Math.PI*2,!0),c.lineWidth=Math.round(this.radius/5)<2?2:Math.round(this.radius/5),c.strokeStyle=this.color,c.stroke()}};this.MarkPoint.prototype.draw2=function(a){this.update();var c;switch(b){case "circle":for(c=0;c<3;)a.beginPath(),a.arc(this.x,this.y,this.radius+this.radius*(e.scaleSize-1)*this.energy[c],0,Math.PI*2,!0),a.strokeStyle="rgba"+this.rgbColor.slice(3).split(")")[0]+","+(1-this.energy[c])+")",a.stroke(),c++;break;case "ring":for(c=
0;c<4;)a.beginPath(),a.arc(this.x,this.y,this.radius*this.energy[c],0,Math.PI*2,!0),a.fillStyle="rgba"+this.rgbColor.slice(3).split(")")[0]+","+Math.max(1-this.energy[c]/e.scaleSize,0)+")",a.fill(),c++;break;case "emptyCircle":a.beginPath(),a.arc(this.x,this.y,this.radius*this.energy,0,Math.PI*2,!0),a.strokeStyle=this.color,a.stroke()}if(h.show)a.font=h.fontStyle+" "+h.fontWeight+" "+h.fontSize+"px "+h.fontFamily,a.textAlign=h.align,a.textBaseline=h.baseline,a.fillStyle=h.color?h.color:this.color,
a.fillText(this.value,this.x,this.y)}},_initMarkLine:function(){var a=this,b=this._rendererOptions.markLine.effect,c=this._rendererOptions.markLine.itemStyle;this.MarkLine=function(d,e,f){var g=this;this.index=d;this.start=e;this.end=f;this.color=c.color?c.color:a.direction==="out"?f.color:e.color;this.width=c.width;this.effect={radius:c.width*b.scaleSize/2,color:b.color,increment:0.1/b.period,init:function(){this.energy=0},update:function(){this.energy<1?(this.energy+=this.increment,a._rendererOptions.markLine.curveness!==
0?(this.x=Math.pow(1-this.energy,2)*g.p1.x+2*this.energy*(1-this.energy)*g.cp.x+Math.pow(this.energy,2)*g.p2.x,this.y=Math.pow(1-this.energy,2)*g.p1.y+2*this.energy*(1-this.energy)*g.cp.y+Math.pow(this.energy,2)*g.p2.y):(this.x=g.p1.x+this.energy*(g.p2.x-g.p1.x),this.y=g.p1.y+this.energy*(g.p2.y-g.p1.y))):this.init()},draw:function(a){this.update();a.beginPath();a.arc(this.x,this.y,this.radius,0,Math.PI*2,!0);a.fillStyle=this.color;a.fill();a.closePath()}}};this.MarkLine.prototype.updateXY=function(){this.p1=
a._parent.map.project([this.start.lon,this.start.lat]);this.p2=a._parent.map.project([this.end.lon,this.end.lat]);a._rendererOptions.markLine.curveness!==0&&this.getControlPoint()};this.MarkLine.prototype.getControlPoint=function(){var b=a._rendererOptions.markLine.curveness/2,c=Math.sqrt(Math.pow(this.p1.x-this.p2.x,2)+Math.pow(this.p1.y-this.p2.y,2)),f=c/2/Math.cos(b);this.p1.x===this.p2.x?this.cp=this.p1.y>this.p2.y?{x:this.p1.x-Math.round(f*Math.sin(b)),y:this.p1.y-Math.round(f*Math.cos(b))}:
this.p1.y===this.p2.y?{x:this.p1.x,y:this.p1.y}:{x:this.p1.x+Math.round(f*Math.sin(b)),y:this.p1.y+Math.round(f*Math.cos(b))}:this.p1.x<this.p2.x?this.p1.y>this.p2.y?(c=Math.asin((this.p2.x-this.p1.x)/c),this.cp=c<b?{x:this.p1.x-Math.round(f*Math.sin(b-c)),y:this.p1.y-Math.round(f*Math.cos(b-c))}:c===b?{x:this.p1.x,y:this.p1.y-f}:{x:this.p1.x+Math.round(f*Math.sin(c-b)),y:this.p1.y-Math.round(f*Math.cos(c-b))}):this.p1.y===this.p2.y?this.cp={x:this.p1.x+Math.round(f*Math.cos(b)),y:this.p1.y-Math.round(f*
Math.sin(b))}:(c=Math.PI-Math.asin((this.p2.x-this.p1.x)/c),this.cp=c<Math.PI/2+b?{x:this.p1.x+Math.round(f*Math.cos(b-(c-Math.PI/2))),y:this.p1.y-Math.round(f*Math.sin(b-(c-Math.PI/2)))}:c===Math.PI/2+b?{x:this.p1.x+f,y:this.p1.y}:{x:this.p1.x+Math.round(f*Math.cos(c-Math.PI/2-b)),y:this.p1.y+Math.round(f*Math.sin(c-Math.PI/2-b))}):this.p1.y<this.p2.y?(c=Math.PI+Math.asin((this.p1.x-this.p2.x)/c),this.cp=c<Math.PI+b?{x:this.p1.x+Math.round(f*Math.sin(b-(c-Math.PI))),y:this.p1.y+Math.round(f*Math.cos(b-
(c-Math.PI)))}:c===Math.PI+b?{x:this.p1.x,y:this.p1.y+f}:{x:this.p1.x-Math.round(f*Math.sin(c-Math.PI-b)),y:this.p1.y+Math.round(f*Math.cos(c-Math.PI-b))}):this.p1.y===this.p2.y?this.cp={x:this.p1.x-Math.round(f*Math.cos(b)),y:this.p1.y+Math.round(f*Math.sin(b))}:(c=Math.PI*3/2+Math.acos((this.p1.x-this.p2.x)/c),this.cp=c<Math.PI*3/2+b?{x:this.p1.x-Math.round(f*Math.cos(b-(c-Math.PI*3/2))),y:this.p1.y+Math.round(f*Math.sin(b-(c-Math.PI*3/2)))}:c===Math.PI*3/2+b?{x:this.p1.x-f,y:this.p1.y}:{x:this.p1.x-
Math.round(f*Math.cos(c-Math.PI*3/2-b)),y:this.p1.y-Math.round(f*Math.sin(c-Math.PI*3/2-b))})};this.MarkLine.prototype.isPointInStroke=function(b,c,f){b.beginPath();b.moveTo(this.p1.x,this.p1.y);a._rendererOptions.markLine.curveness!==0?b.quadraticCurveTo(this.cp.x,this.cp.y,this.p2.x,this.p2.y):b.lineTo(this.p2.x,this.p2.y);if(b.isPointInStroke(c,f))a.hoveredMarkLine=this};this.MarkLine.prototype.draw=function(b){a.hoveredMarkLine===this?(this.color=GeoGlobe.Util.getShadeColor(c.color?c.color:a.direction===
"out"?this.end.color:this.start.color,20),this.width=c.width*1.1):(this.color=c.color?c.color:a.direction==="out"?this.end.color:this.start.color,this.width=c.width);b.beginPath();b.moveTo(this.p1.x,this.p1.y);a._rendererOptions.markLine.curveness!==0?b.quadraticCurveTo(this.cp.x,this.cp.y,this.p2.x,this.p2.y):b.lineTo(this.p2.x,this.p2.y);b.lineWidth=this.width;b.strokeStyle=this.color;b.stroke()}},_initCanvas:function(){this.canvas=[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));
this.canvas.push(document.createElement("canvas"));this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.canvasContext.push(this.canvas[1].getContext("2d"));this.canvasContext.push(this.canvas[2].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));
this.cacheCanvasContext.push(this.cacheCanvas[1].getContext("2d"));this.cacheCanvasContext.push(this.cacheCanvas[2].getContext("2d"));this.canvas[0].width=this.canvas[1].width=this.canvas[2].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.cacheCanvas[2].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.canvas[2].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.cacheCanvas[2].height=this.height=this._parent.map.transform.height;
this.canvas[0].style.position="absolute";this.canvas[1].style.position="absolute";this.canvas[2].style.position="absolute";this._parent.container.appendChild(this.canvas[0]);this._parent.container.appendChild(this.canvas[1]);this._parent.container.appendChild(this.canvas[2]);this.setVisible(this.visibility)},_initTooltip:function(){if((this._rendererOptions.markLine.hoverable||this._rendererOptions.markPoint.hoverable)&&this._rendererOptions.tooltip.show)this.tooltipDiv=this.tooltipDiv||this._parent.container.appendChild(document.createElement("div")),
this.tooltipDiv.style.position="absolute",this.tooltipDiv.style.display="none",this.tooltipDiv.style.zIndex=999,this.tooltipDiv.style.color=this._rendererOptions.tooltip.textStyle.color,this.tooltipDiv.style.padding=this._rendererOptions.tooltip.padding+"px",this.tooltipDiv.style.font=this._rendererOptions.tooltip.textStyle.fontStyle+" "+this._rendererOptions.tooltip.textStyle.fontWeight+" "+this._rendererOptions.tooltip.textStyle.fontSize+"px "+this._rendererOptions.tooltip.textStyle.fontFamily,
this.tooltipDiv.style["background-color"]=document.createElement("canvas").getContext?this._rendererOptions.tooltip.backgroundColor:GeoGlobe.Util.getRgbColor(this._rendererOptions.tooltip.backgroundColor),this.tooltipDiv.style["border-width"]=this._rendererOptions.tooltip.borderWidth+"px",this.tooltipDiv.style["border-color"]=this._rendererOptions.tooltip.borderColor,this.tooltipDiv.style["border-radius"]=this._rendererOptions.tooltip.borderRadius+"px",this.tooltipDiv.style["border-style"]="solid",
this.tooltipDiv.style["white-space"]="nowrap",this.tooltipDiv.style.transition="left 0.4s, top 0.4s"},render:function(){this._initCanvas();this._initTooltip();var a,b=this;(function d(){requestAnimationFrame(d);if(b._parent.moving||b.RELOADED||b.RESIZE){for(a=b.markPoints.length;a--;)b.markPoints[a].updateXY(),b.markLines[a].updateXY();b.cacheCanvas[1].width=b.width;b.cacheCanvas[2].width=b.width;b.draw1();b.RELOADED&&(b.RELOADED=!1);b.RESIZE&&(b.RESIZE=!1)}b.draw2();b.draw3()})();this.RENDERED=!0},
mouseMove:function(a){if((this._rendererOptions.markLine.hoverable||this._rendererOptions.markPoint.hoverable)&&this.visibility&&this.markPoints.length>0&&!this._parent.map.moving)this.hover(a.point.x,a.point.y),this.hoveredMarkPoint&&this._parent.fire("overlayerhover",{layer:this,feature:this.hoveredMarkPoint,event:a})},resize:function(){this.canvas[0].width=this.canvas[1].width=this.canvas[2].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.cacheCanvas[2].width=this.width=this._parent.map.transform.width;
this.canvas[0].height=this.canvas[1].height=this.canvas[2].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.cacheCanvas[2].height=this.height=this._parent.map.transform.height;this.RESIZE=!0},draw1:function(){this.cacheCanvas[0].width=this.width;for(var a=this.markLines.length;a--;)this.markLines[a].draw(this.cacheCanvasContext[0]);for(a=this.markPoints.length;a--;)this.markPoints[a].draw1(this.cacheCanvasContext[0]);this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],
0,0)},draw2:function(){document.createElement("canvas").getContext?(this.cacheCanvasContext[1].globalCompositeOperation="destination-out",this.cacheCanvasContext[1].fillStyle="rgba(0, 0, 0, 0.05)",this.cacheCanvasContext[1].fillRect(0,0,this.width,this.height),this.cacheCanvasContext[1].globalCompositeOperation="source-over"):this.cacheCanvas[1].width=this.width;this.cacheCanvasContext[1].save();for(var a=this.markLines.length;a--;)this.markLines[a].effect.draw(this.cacheCanvasContext[1]);this.cacheCanvasContext[1].restore();
this.canvas[1].width=this.width;this.canvasContext[1].drawImage(this.cacheCanvas[1],0,0)},draw3:function(){this._rendererOptions.markPoint.symbol==="emptyCircle"?document.createElement("canvas").getContext?(this.cacheCanvasContext[2].globalCompositeOperation="destination-out",this.cacheCanvasContext[2].fillStyle="rgba(0, 0, 0, 0.05)",this.cacheCanvasContext[2].fillRect(0,0,this.width,this.height),this.cacheCanvasContext[2].globalCompositeOperation="source-over"):this.cacheCanvas[2].width=this.width:
this._rendererOptions.markPoint.symbol==="ring"?(this.cacheCanvas[2].width=this.width,this.cacheCanvasContext[2].globalCompositeOperation="lighter"):this.cacheCanvas[2].width=this.width;this.cacheCanvasContext[2].save();for(var a=this.markPoints.length;a--;)this.markPoints[a].draw2(this.cacheCanvasContext[2]);this.cacheCanvasContext[2].restore();this.canvas[2].width=this.width;this.canvasContext[2].drawImage(this.cacheCanvas[2],0,0)},hover:function(a,b){this.hoveredMarkLine=null;this.lastHoveredMarkPoint=
this.hoveredMarkPoint?GeoGlobe.Util.clone(this.hoveredMarkPoint):null;this.hoveredMarkPoint=null;var c,d;c=0;for(d=this.markLines.length;c<d;c++)!this.hoveredMarkLine&&this.markLines[c].isPointInStroke(this.cacheCanvasContext[0],a,b);c=0;for(d=this.markPoints.length;c<d;c++)!this.hoveredMarkPoint&&this.markPoints[c].isPointInPath(this.cacheCanvasContext[0],a,b);this.draw1();this.hoveredMarkLine||this.hoveredMarkPoint?(this.showTooltip(this.hoveredMarkLine?this.hoveredMarkLine.start.name+" > "+this.hoveredMarkLine.end.name:
this.hoveredMarkPoint.name,a,b),this.canvas[2].style.cursor="pointer"):(this.hideTooltip(),this.canvas[2].style.cursor="default")},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=a,this.tooltipDiv.style.top=c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display="none"},addTo:function(a){this._parent=a;this._parent.addLayer(this)},setVisible:function(a){this.visibility=
a;this.canvas[0].style.display=this.canvas[1].style.display=this.canvas[2].style.display=a?"block":"none"},setData:function(a){this.data=a;this.minValue=Number.MAX_VALUE;this.maxValue=Number.MIN_VALUE;for(var b=0;b<a.length;b++){if(a[b].properties.value<this.minValue)this.minValue=a[b].properties.value;if(a[b].properties.value>this.maxValue)this.maxValue=a[b].properties.value}for(var c=new this.MarkPoint(void 0,this.location.name,0,this.location.lonLat[0],this.location.lonLat[1]),d=[],e=[],b=0;b<
a.length;b++)d.push(new this.MarkPoint(b,a[b].properties.name,a[b].properties.value,a[b].geometry.coordinates[0],a[b].geometry.coordinates[1])),e.push(this.direction==="out"?new this.MarkLine(b,c,d[b]):new this.MarkLine(b,d[b],c));this.hoveredMarkLine=this.hoveredMarkPoint=null;this.markPoints=d;this.markLines=e;this.RELOADED=!0}});
GeoGlobe.Visuals.Custom.Commute=GeoGlobe.Class4OL({_parent:null,canvas:[],cacheCanvas:[],canvasContext:[],cacheCanvasContext:[],MarkPoint:null,MarkLine:null,markPoints:[],markLines:{items:[],option:{}},initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this._init_RendererOptions();this._initMarkPoint();this._initMarkLine();this.setData(this.data)},_init_RendererOptions:function(){this._rendererOptions=GeoGlobe.Util.deepExtend({},{markLine:{effect:{color:"rgba(255,255,255,0.7)",scaleSize:60,
period:15},itemStyle:{color:"rgba(255,58,53,0.9)",width:0.1}},markPoint:{hoverable:!0,symbolSize:30,effect:{scaleSize:2,period:15},itemStyle:{color:"rgba(255,255,255,0.7)"}},tooltip:{show:!0,backgroundColor:"rgba(0,0,0,0.7)",borderColor:"#333",borderRadius:0,borderWidth:0,padding:5,textStyle:{color:"#fff",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}}},this.rendererOptions)},_initMarkPoint:function(){var a=this,b=this._rendererOptions.markPoint.symbolSize,c=this._rendererOptions.markPoint.effect,
d=this._rendererOptions.markPoint.itemStyle;this.MarkPoint=function(a,c,g,h){this.index=a;this.name=c;this.lon=g;this.lat=h;this.init();this.radius=b/2;this.color=d.color;this.rgbColor=GeoGlobe.Util.getRgbColor(d.color)};this.MarkPoint.prototype.init=function(){this.energy=0;this.increment=0.1*c.scaleSize/c.period+Math.random()*(Math.random()>0.5?1:-1)*0.002};this.MarkPoint.prototype.updateXY=function(){var b=a._parent.map.project([this.lon,this.lat]);this.x=b.x;this.y=b.y};this.MarkPoint.prototype.update=
function(){this.energy<c.scaleSize?this.energy+=this.increment:this.energy=0};this.MarkPoint.prototype.isPointInPath=function(b,c,d){b.beginPath();b.arc(this.x,this.y,this.radius,0,Math.PI*2,!0);if(b.isPointInPath(c,d))a.hoveredMarkPoint=this};this.MarkPoint.prototype.draw=function(b){this.update();b.beginPath();b.arc(this.x,this.y,this.radius*this.energy,0,Math.PI*2,!0);b.globalAlpha=1;b.strokeStyle=this.color;b.stroke();if(a.hoveredMarkPoint===this)b.beginPath(),b.arc(this.x,this.y,this.radius*
c.scaleSize/2,0,Math.PI*2,!0),b.lineWidth=Math.round(this.radius/5)<2?2:Math.round(this.radius/5),b.strokeStyle=this.color,b.globalAlpha=0.1,b.stroke()}},_initMarkLine:function(){var a=this,b=this._rendererOptions.markLine.effect,c=this._rendererOptions.markLine.itemStyle;this.MarkLine=function(d,e){this.index=d;this.points=e;if(d<~~(a.markLines.option.linesNumber/10)){var f=this;this.effect={radius:c.width*b.scaleSize/2,color:b.color,pointIndex:~~(Math.random()*this.points.length),update:function(){a.markLines.option.factor===
1?(this.pointIndex+=a.markLines.option.lineIncrement+0.1,this.pointIndex>f.points.length-1&&(this.pointIndex=0)):(this.pointIndex-=a.markLines.option.lineIncrement-0.1,this.pointIndex<0&&(this.pointIndex=f.points.length-1));this.pointIndex=Math.round(this.pointIndex)},draw:function(b){this.update();b.beginPath();d<~~(a.markLines.option.linesNumber/200)?b.arc(f.points[this.pointIndex].x,f.points[this.pointIndex].y,this.radius,0,Math.PI*2,!0):b.rect(f.points[this.pointIndex].x-1,f.points[this.pointIndex].y-
1,2,2);b.fillStyle=this.color;b.fill()}}}};this.MarkLine.prototype.updateXY=function(){for(var b=0;b<this.points.length;b++){var c=a._parent.map.project([this.points[b].lon,this.points[b].lat]);this.points[b].x=c.x;this.points[b].y=c.y}};this.MarkLine.prototype.path=function(a,b){a>this.points.length&&(a=this.points.length);for(var c=0;c<a;c++)c===0?b.moveTo(this.points[0].x,this.points[0].y):b.lineTo(this.points[c].x,this.points[c].y)}},_initCanvas:function(){this.canvas=[];this.canvasContext=[];
this.canvas.push(document.createElement("canvas"));this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.canvasContext.push(this.canvas[1].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.cacheCanvasContext.push(this.cacheCanvas[1].getContext("2d"));
this.canvas[0].width=this.canvas[1].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.height=this._parent.map.transform.height;this.canvas[0].style.position="absolute";this.canvas[1].style.position="absolute";this._parent.container.appendChild(this.canvas[0]);this._parent.container.appendChild(this.canvas[1]);this.setVisible(this.visibility)},_initTooltip:function(){if(this._rendererOptions.markPoint.hoverable&&
this._rendererOptions.tooltip.show)this.tooltipDiv=this.tooltipDiv||this._parent.container.appendChild(document.createElement("div")),this.tooltipDiv.style.position="absolute",this.tooltipDiv.style.display="none",this.tooltipDiv.style.zIndex=999,this.tooltipDiv.style.color=this._rendererOptions.tooltip.textStyle.color,this.tooltipDiv.style.padding=this._rendererOptions.tooltip.padding+"px",this.tooltipDiv.style.font=this._rendererOptions.tooltip.textStyle.fontStyle+" "+this._rendererOptions.tooltip.textStyle.fontWeight+
" "+this._rendererOptions.tooltip.textStyle.fontSize+"px "+this._rendererOptions.tooltip.textStyle.fontFamily,this.tooltipDiv.style["background-color"]=document.createElement("canvas").getContext?this._rendererOptions.tooltip.backgroundColor:GeoGlobe.Util.getRgbColor(this._rendererOptions.tooltip.backgroundColor),this.tooltipDiv.style["border-width"]=this._rendererOptions.tooltip.borderWidth+"px",this.tooltipDiv.style["border-color"]=this._rendererOptions.tooltip.borderColor,this.tooltipDiv.style["border-radius"]=
this._rendererOptions.tooltip.borderRadius+"px",this.tooltipDiv.style["border-style"]="solid",this.tooltipDiv.style["white-space"]="nowrap",this.tooltipDiv.style.transition="left 0.4s, top 0.4s"},render:function(){this._initCanvas();this._initTooltip();var a,b=this;(function d(){requestAnimationFrame(d);if(b._parent.moving||b.RELOADED||b.RESIZE){for(a=b.markLines.items.length;a--;)b.markLines.items[a].updateXY();for(a=b.markPoints.length;a--;)b.markPoints[a].updateXY();b.cacheCanvas[1].width=b.width;
b.RELOADED&&(b.RELOADED=!1);b.RESIZE&&(b.RESIZE=!1)}b.draw1();b.draw2()})();this.RENDERED=!0},mouseMove:function(a){this._rendererOptions.markPoint.hoverable&&this.visibility&&this.markPoints.length>0&&!this._parent.map.moving&&(this.hover(a.point.x,a.point.y),this.hoveredMarkPoint&&this._parent.fire("overlayerhover",{layer:this,feature:this.hoveredMarkPoint,event:a}))},resize:function(){this.canvas[0].width=this.canvas[1].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.width=this._parent.map.transform.width;
this.canvas[0].height=this.canvas[1].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.height=this._parent.map.transform.height;this.RESIZE=!0},draw1:function(){this.cacheCanvas[0].width=this.width;this.cacheCanvasContext[0].globalCompositeOperation="lighter";var a,b,c=this.markLines.items,d=this.markLines.option;if(c.length>0){this.cacheCanvasContext[0].beginPath();switch(d.step){case 1:d.lineLength+=d.lineIncrement+0.1;a=0;for(b=~~(d.linesNumber*2/3);a<b;a++)c[a].path(Math.round(d.lineLength),
this.cacheCanvasContext[0]);d.lineLength>d.linePointsNumber-1&&(d.factor=1,d.lineLength=0,d.step=2);break;case 2:a=0;for(b=~~(d.linesNumber*2/3);a<b;a++)c[a].path(d.linePointsNumber,this.cacheCanvasContext[0]);d.lineLength+=d.lineIncrement+0.1;a=~~(d.linesNumber*2/3);for(b=d.linesNumber;a<b;a++)c[a].path(Math.round(d.lineLength),this.cacheCanvasContext[0]);d.lineLength>d.linePointsNumber-1&&(d.factor=-1,d.lineLength=d.linePointsNumber-1,d.step=3);break;case 3:a=0;for(b=~~(d.linesNumber*2/3);a<b;a++)c[a].path(d.linePointsNumber,
this.cacheCanvasContext[0]);d.lineLength-=d.lineIncrement-0.1;a=~~(d.linesNumber*2/3);for(b=d.linesNumber;a<b;a++)c[a].path(Math.round(d.lineLength),this.cacheCanvasContext[0]);d.lineLength<0&&(d.factor=-1,d.lineLength=d.linePointsNumber-1,d.step=4);break;case 4:d.lineLength-=d.lineIncrement-0.1;a=0;for(b=~~(d.linesNumber*2/3);a<b;a++)c[a].path(Math.round(d.lineLength),this.cacheCanvasContext[0]);d.lineLength<0&&(d.factor=1,d.lineLength=0,d.step=1)}this.cacheCanvasContext[0].lineWidth=this._rendererOptions.markLine.itemStyle.width;
this.cacheCanvasContext[0].strokeStyle=this._rendererOptions.markLine.itemStyle.color;this.cacheCanvasContext[0].stroke();a=~~(this.markLines.option.linesNumber/200);for(b=~~(this.markLines.option.linesNumber/10);a<b;a++)this.markLines.items[a].effect.draw(this.cacheCanvasContext[0])}this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},draw2:function(){document.createElement("canvas").getContext?(this.cacheCanvasContext[1].globalCompositeOperation="destination-out",
this.cacheCanvasContext[1].fillStyle="rgba(0, 0, 0, 0.05)",this.cacheCanvasContext[1].fillRect(0,0,this.width,this.height),this.cacheCanvasContext[1].globalCompositeOperation="source-over"):this.cacheCanvas[1].width=this.width;this.cacheCanvasContext[1].save();if(this.markLines.items.length>0)for(var a=0;a<~~(this.markLines.option.linesNumber/200);a++)this.markLines.items[a].effect.draw(this.cacheCanvasContext[1]);for(a=this.markPoints.length;a--;)this.markPoints[a].draw(this.cacheCanvasContext[1]);
this.cacheCanvasContext[1].restore();this.canvas[1].width=this.width;this.canvasContext[1].drawImage(this.cacheCanvas[1],0,0)},hover:function(a,b){this.lastHoveredMarkPoint=this.hoveredMarkPoint?GeoGlobe.Util.clone(this.hoveredMarkPoint):null;this.hoveredMarkPoint=null;this.cacheCanvasContext[1].save();for(var c=0,d=this.markPoints.length;c<d;c++)!this.hoveredMarkPoint&&this.markPoints[c].isPointInPath(this.cacheCanvasContext[1],a,b);this.cacheCanvasContext[1].restore();this.hoveredMarkPoint?(this.canvas[1].style.cursor=
"pointer",this.showTooltip(this.hoveredMarkPoint.name,a,b)):(this.canvas[1].style.cursor="default",this.hideTooltip())},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=a,this.tooltipDiv.style.top=c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display="none"},addTo:function(a){this._parent=a;this._parent.addLayer(this)},setVisible:function(a){this.visibility=
a;this.canvas[0].style.display=this.canvas[1].style.display=a?"block":"none"},setData:function(a){this.data=a;this.markLines.option={step:1,factor:1,linesNumber:a.length,linePointsNumber:a[0].geometry.coordinates.length,lineLength:0,lineIncrement:10/this._rendererOptions.markLine.effect.period};for(var b=0;b<a.length;b++){for(var c=[],d=0;d<a[b].geometry.coordinates.length;d++)c.push({lon:a[b].geometry.coordinates[d][0],lat:a[b].geometry.coordinates[d][1]});this.markLines.items.push(new this.MarkLine(b,
c))}b=a[a.length-1].geometry.coordinates[a[a.length-1].geometry.coordinates.length-1];this.markPoints.push(new this.MarkPoint(0,a[a.length-1].properties.name||"\u7ec8\u70b9",b[0],b[1]));this.RELOADED=!0}});
GeoGlobe.Visuals.Custom.Scatter=GeoGlobe.Class4OL({_parent:null,canvas:[],cacheCanvas:[],canvasContext:[],cacheCanvasContext:[],MarkPointsSet:null,markPointsSets:[],legendLabels:[],initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this._init_Legend();this._init_RendererOptions();this._initMarkPointsSet();this.setData(this.data)},_init_Legend:function(){this._legend=GeoGlobe.Util.deepExtend({},{show:!0,left:null,right:null,top:null,bottom:null,col:1,itemSize:10,itemColors:[],itemStatuses:[],
backgroundColor:"rgba(0,0,0,0.5)",borderColor:"#000",borderWidth:1,borderRadius:0,shadowColor:"#fff",shadowBlur:5,shadowOffsetX:0,shadowOffsetY:0,padding:10,textStyle:{color:"#fff",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}},this.legend)},_init_RendererOptions:function(){this._rendererOptions=GeoGlobe.Util.deepExtend({},{markPoint:{unactivatedDrawable:!0,symbol:"square",symbolSize:2,itemStyle:{color:"rgba(255,0,0,0.7)",shadowColor:"#000",shadowBlur:0,shadowOffsetX:0,shadowOffsetY:0}},
tooltip:{show:!0,backgroundColor:"rgba(0,0,0,0.7)",borderColor:"#333",borderRadius:0,borderWidth:0,padding:5,textStyle:{color:"#fff",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}}},this.rendererOptions)},_initMarkPointsSet:function(){var a=this,b=this._legend.itemColors,c=this._legend.itemStatuses,d=this._rendererOptions.markPoint.unactivatedDrawable,e=this._rendererOptions.markPoint.symbol,f=this._rendererOptions.markPoint.symbolSize,g=this._rendererOptions.markPoint.itemStyle;
this.MarkPointsSet=function(a,b){this.legendLabel=a;this.markPoints=b};this.MarkPointsSet.prototype.updateXY=function(){for(var b=this.markPoints.length;b--;){var c=a._parent.map.project([this.markPoints[b].lon,this.markPoints[b].lat]);this.markPoints[b].x=c.x;this.markPoints[b].y=c.y}};this.MarkPointsSet.prototype.draw=function(a,j){if(d||c[j]!==0){a.globalCompositeOperation="lighter";a.fillStyle=c[j]===0?"gray":b[j]?b[j]:g.color;for(var l,n=this.markPoints.length;n--;){l=this.markPoints[n];a.beginPath();
switch(e){case "square":a.rect(l.x-f/2,l.y-f/2,f,f);break;case "round":a.arc(l.x,l.y,f/2,0,Math.PI*2,!1)}a.fill()}}}},_initCanvas:function(){this.canvas=[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.canvas[0].width=this.cacheCanvas[0].width=
this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height;this.canvas[0].style.position="absolute";this._parent.container.appendChild(this.canvas[0]);this.setVisible(this.visibility)},render:function(){this._initCanvas();var a,b=this;(function d(){requestAnimationFrame(d);if(b._parent.moving||b.RESIZE){for(a=b.markPointsSets.length;a--;)b.markPointsSets[a].updateXY();b.draw();b.RESIZE&&(b.RESIZE=!1)}if(b.RELOADED)b.drawLegend(b.DRAWINDEX),
b.markPointsSets[b.DRAWINDEX].draw(b.cacheCanvasContext[0],b.DRAWINDEX),b.canvas[0].width=b.width,b.canvasContext[0].drawImage(b.cacheCanvas[0],0,0),b.DRAWINDEX++,b.DRAWINDEX===b.legendLabels.length&&(b.RELOADED=!1)})();this.RENDERED=!0},resize:function(){this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height;this.RESIZE=!0},draw:function(){this.cacheCanvas[0].width=this.width;
for(var a=0,b=this.markPointsSets.length;a<b;a++)this.markPointsSets[a].draw(this.cacheCanvasContext[0],a);this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},drawLegend:function(a){if(this._legend&&this._legend.show){if(!this.legendDiv)this.legendDiv=document.createElement("div"),this.legendDiv.style.display=this.visibility?"block":"none",this.legendDiv.style.zIndex=9999,this.legendDiv.style.position="absolute",this.legendDiv.style["background-color"]=this._legend.backgroundColor,
this.legendDiv.style["border-color"]=this._legend.borderColor,this.legendDiv.style["border-width"]=this._legend.borderWidth+"px",this.legendDiv.style["border-radius"]=this._legend.borderRadius+"px",this.legendDiv.style["border-style"]="solid",this.legendDiv.style["box-shadow"]=this._legend.shadowOffsetX+"px "+this._legend.shadowOffsetY+"px "+this._legend.shadowBlur+"px "+this._legend.shadowColor,this.legendDiv.style.padding=this._legend.padding+"px",this.legendDiv.style.left=this._legend.left!==null?
this._legend.left+"px":null,this.legendDiv.style.right=this._legend.right!==null?this._legend.right+"px":null,this.legendDiv.style.top=this._legend.top!==null?this._legend.top+"px":null,this.legendDiv.style.bottom=this._legend.bottom!==null?this._legend.bottom+"px":null,this.legendCanvas=document.createElement("canvas"),this.legendCanvasContext=this.legendCanvas.getContext("2d"),this.legendCanvas.style.display="block",this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+
" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily,this.legendDiv.appendChild(this.legendCanvas),this._parent.container.parentNode.parentNode.parentNode.appendChild(this.legendDiv);for(var b=[],c=null,d=0,e=this.legendLabels.length;d<e;d++)for(var c=this._legend.itemSize+10+this.legendCanvasContext.measureText(this.legendLabels[d].toString()).width,f=this._legend.col,g=0;g<f;g++)d%this._legend.col===g&&(!b[g]||b[g]<c)&&(b[g]=c);for(var h=10,c=10,d=0,e=b.length;d<e;d++)h+=
b[d]+10;c+=((this._legend.itemSize<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemSize)+10)*(~~(this.legendLabels.length/this._legend.col)+(this.legendLabels.length%this._legend.col===0?0:1));this.legendCanvas.width=h;this.legendCanvas.height=c;var j=function(a,c,d,e){this.legendCanvas.width=h;for(var f=!1,g,j,q=0,a=a!==void 0?a+1:this.legendLabels.length;q<a;q++){j=0;for(var s=this._legend.col;j<s;j++)if(q%this._legend.col===j){g=10+this._legend.itemSize/2;for(var u=
0;u<j;u++)g+=b[u]+10}j=10+this._legend.itemSize/2+((this._legend.itemSize<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemSize)+10)*~~(q/this._legend.col);u=s=!1;this.legendCanvasContext.beginPath();switch(this._rendererOptions.markPoint.symbol){case "square":this.legendCanvasContext.rect(g-this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "round":this.legendCanvasContext.arc(g,j,this._legend.itemSize/2,0,Math.PI*
2,!1)}c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(f=s=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(u=!0);this.legendCanvasContext.beginPath();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.rect(g+this._legend.itemSize/2+10,j-this._legend.textStyle.fontSize/
2,this.legendCanvasContext.measureText(this.legendLabels[q].toString()).width,this._legend.textStyle.fontSize);c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(f=s=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(u=!0);u&&(this._legend.itemStatuses[q]=this._legend.itemStatuses[q]===0?1:0,this.draw());var v=this._legend.itemStatuses[q]===0?"#808080":this._legend.itemColors[q]?this._legend.itemColors[q]:this._rendererOptions.markPoint.itemStyle.color,
y=this._legend.itemStatuses[q]===0?"#808080":this._legend.textStyle.color,v=s||u?GeoGlobe.Util.getShadeColor(v,20):v,y=s||u?GeoGlobe.Util.getShadeColor(y,20):y;this.legendCanvasContext.beginPath();switch(this._rendererOptions.markPoint.symbol){case "square":this.legendCanvasContext.rect(g-this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "round":this.legendCanvasContext.arc(g,j,this._legend.itemSize/2,0,Math.PI*2,!1)}this.legendCanvasContext.fillStyle=
v;this.legendCanvasContext.fill();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.textAlign="left";this.legendCanvasContext.textBaseline="middle";this.legendCanvasContext.fillStyle=y;this.legendCanvasContext.fillText(this.legendLabels[q],g+this._legend.itemSize/2+10,j)}this.legendCanvas.style.cursor=f?"pointer":"default"}.bind(this);this.legendCanvas.onmousedown=
function(a){var b=a.offsetX||a.clientX-(a.target||a.srcElement).getBoundingClientRect().left,c=a.offsetY||a.clientY-(a.target||a.srcElement).getBoundingClientRect().top;j(void 0,a.type,b,c)};this.legendCanvas.onmousemove=function(a){var b=a.offsetX||a.clientX-(a.target||a.srcElement).getBoundingClientRect().left,c=a.offsetY||a.clientY-(a.target||a.srcElement).getBoundingClientRect().top;j(void 0,a.type,b,c)};j(a)}},addTo:function(a){this._parent=a;this._parent.addLayer(this)},setVisible:function(a){this.visibility=
a;this.canvas[0].style.display=a?"block":"none";this.legendDiv&&(this.legendDiv.style.display=a?"block":"none")},setData:function(a){this.data=a;a=new Blob(["function MarkPoint(lon, lat) {this.lon = lon;this.lat = lat;}function MarkPointsSet(legendLabel) {this.legendLabel = legendLabel;this.markPoints = [];}var legendLabels = [];var markPointsSets = [];onmessage = function (evt) {var features = evt.data.data;var feature = null;var legendLabel = null;for (var i = 0, len = features.length; i < len; i++) {feature = features[i];legendLabel = feature.properties.name;if (legendLabels.indexOf(legendLabel) === -1) {legendLabels.push(legendLabel);markPointsSets.push(new MarkPointsSet(legendLabel));}markPointsSets[legendLabels.indexOf(legendLabel)].markPoints.push(new MarkPoint(feature.geometry.coordinates[0], feature.geometry.coordinates[1]));}postMessage({legendLabels: legendLabels,markPointsSets: markPointsSets});};"]);
a=window.URL.createObjectURL(a);a=new Worker(a);a.postMessage({data:this.data});a.onmessage=function(a){this.legendLabels=a.data.legendLabels;for(var c,d=0,e=a.data.markPointsSets.length;d<e;d++)c=new this.MarkPointsSet(a.data.markPointsSets[d].legendLabel,a.data.markPointsSets[d].markPoints),c.updateXY(),this.markPointsSets.push(c);this.RELOADED=!0;this.DRAWINDEX=0}.bind(this)}});
GeoGlobe.Visuals.Custom.Proportion=GeoGlobe.Class4OL({_parent:null,canvas:[],cacheCanvas:[],canvasContext:[],cacheCanvasContext:[],MarkPoint:null,markPoints:[],initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this._init_Legend();this._init_RendererOptions();this._initMarkPoint();this.setData(this.data)},_init_Legend:function(){this._legend=GeoGlobe.Util.deepExtend({},{show:!0,left:null,right:null,top:null,bottom:null,col:1,itemWidth:20,itemHeight:12,itemColors:[],itemStatuses:[],
hLegendLabels:[],vLegendLabels:[],backgroundColor:"rgba(0,0,0,0.5)",borderColor:"#000",borderWidth:1,borderRadius:0,shadowColor:"#fff",shadowBlur:5,shadowOffsetX:0,shadowOffsetY:0,padding:10,textStyle:{color:"#fff",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}},this.legend)},_init_RendererOptions:function(){this._rendererOptions=GeoGlobe.Util.deepExtend({},{markPoint:{hoverable:!0,clickable:!0,slope:0.8,symbol:"column",symbolMinSize:0,symbolMaxSize:100,symbolWidth:10,symbolThickness:5,
symbolGap:5,opacity:1,itemStyle:{color:"rgba(255,0,0,0.7)",shadowColor:"#000",shadowBlur:0,shadowOffsetX:0,shadowOffsetY:0}},tooltip:{show:!0,width:null,backgroundColor:"rgba(0,0,0,0.7)",borderColor:"#333",borderRadius:0,borderWidth:0,padding:10,textStyle:{color:"#fff",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}}},this.rendererOptions)},_initMarkPoint:function(){var a=this,b=this._legend.itemColors,c=this._legend.itemStatuses,d=this._rendererOptions.markPoint.symbol,e=this._rendererOptions.markPoint.symbolMinSize,
f=this._rendererOptions.markPoint.symbolMaxSize,g=this._rendererOptions.markPoint.symbolWidth,h=this._rendererOptions.markPoint.symbolThickness,j=this._rendererOptions.markPoint.symbolGap,l=this._rendererOptions.markPoint.opacity,n=this._rendererOptions.markPoint.itemStyle;this.MarkPoint=function(a,b,c,e,f){this.id=a;this.name=b;this.measureValues=c;this.lon=e;this.lat=f;this.init();if(d==="pie"){var g=this;this.Point=function(a,b,c){this.x=a;this.y=b;this.z=c;this.get2d=function(){var a=5E4/(5E4+
this.z);return{x:g.x+this.x*a,y:g.y+this.y*a}}}}};this.MarkPoint.prototype.init=function(){this.energy=0;switch(d){case "column":this.velocity=0.1;break;case "pie":this.velocity=0.05}};this.MarkPoint.prototype.updateXY=function(){var b=a._parent.map.project([this.lon,this.lat]);this.x=b.x;this.y=b.y};this.MarkPoint.prototype.updateSize=function(){var b,g;this.parts=[];for(b=0;b<this.measureValues.length;b++){this.parts.push({size:(f-e)*(a.measureValueMaxSum===a.measureValueMinSum?1:(this.measureValueSums[b]-
a.measureValueMinSum)/(a.measureValueMaxSum-a.measureValueMinSum))+e});switch(d){case "column":this.parts[b].cubes=[];break;case "pie":this.parts[b].sectors=[]}for(g=0;g<this.measureValues[b].length;g++)switch(d){case "column":this.parts[b].cubes.push({height:c[g]===0||this.measureValueSums[b]===0?0:this.measureValues[b][g]/this.measureValueSums[b]*this.parts[b].size});break;case "pie":this.parts[b].sectors.push({angle:c[g]===0||this.measureValueSums[b]===0?0:this.measureValues[b][g]/this.measureValueSums[b]*
Math.PI*2})}}};this.MarkPoint.prototype.updatePartXY=function(){var b=a._rendererOptions.markPoint.slope,c,e,f;switch(d){case "column":var n,l;n=this.parts.length%2===0?this.x-h*Math.cos(b)/2-(this.parts.length/2-1)*g-(this.parts.length/2-0.5)*j:this.x+(g-h*Math.cos(b))/2-(this.parts.length-1)/2*g-(this.parts.length-1)/2*j;l=this.y+h*Math.sin(b)/2;for(c=0;c<this.parts.length;c++)for(e=0;e<this.parts[c].cubes.length;e++){var s=0;for(f=e;f>0;f--)s+=this.parts[c].cubes[f-1].height;this.parts[c].cubes[e].vertexs=
[[n+c*(g+j),l-s],[n+c*(g+j)+h*Math.cos(b),l-h*Math.sin(b)-s],[n+c*(g+j)+h*Math.cos(b)-g,l-h*Math.sin(b)-s],[n+c*(g+j)-g,l-s]]}break;case "pie":var u,v,y,A,C,B=Math.PI*2/50;for(c=0;c<1;c++){f=this.parts[c].size/2;n=f>g?f-g:0;s=new this.Point(0,0,-h/2);u=new this.Point(0,0,h/2);v=[];y=[];A=[];C=[];for(l=0;l<=Math.PI*2;)v.push(new this.Point(f*Math.cos(l),f*Math.sin(l),-h/2)),y.push(new this.Point(f*Math.cos(l),f*Math.sin(l),h/2)),n>0&&(A.push(new this.Point(n*Math.cos(l),n*Math.sin(l),-h/2)),C.push(new this.Point(n*
Math.cos(l),n*Math.sin(l),h/2))),l+=B;v.push(new this.Point(f,0,-h/2));y.push(new this.Point(f,0,h/2));n>0&&(A.push(new this.Point(n,0,-h/2)),C.push(new this.Point(n,0,h/2)));e=Math.cos(b);var z=Math.sin(b),w;l=s.y*e-s.z*z;w=s.z*e+s.y*z;s.y=l;s.z=w;l=u.y*e-u.z*z;w=u.z*e+u.y*z;u.y=l;u.z=w;for(f=0;f<50;f++)if(l=v[f].y*e-v[f].z*z,w=v[f].z*e+v[f].y*z,v[f].y=l,v[f].z=w,l=y[f].y*e-y[f].z*z,w=y[f].z*e+y[f].y*z,y[f].y=l,y[f].z=w,n>0)l=A[f].y*e-A[f].z*z,w=A[f].z*e+A[f].y*z,A[f].y=l,A[f].z=w,l=C[f].y*e-C[f].z*
z,w=C[f].z*e+C[f].y*z,C[f].y=l,C[f].z=w;for(e=0;e<this.parts[c].sectors.length;e++){l=this.parts[c].sectors[e].angle;z=0;for(f=e;f>0;f--)z+=this.parts[c].sectors[f-1].angle;f=z+l;this.parts[c].sectors[e].startIndex=e===0?Math.round(z/B):this.parts[c].sectors[e-1].endIndex;this.parts[c].sectors[e].endIndex=Math.round(f/B)}this.parts[c].uCentrePoint=s;this.parts[c].tCentrePoint=u;this.parts[c].oUnderPoints=v;this.parts[c].oTopPoints=y;if(n>0)this.parts[c].iUnderPoints=A,this.parts[c].iTopPoints=C}}};
this.MarkPoint.prototype.update=function(){this.energy+=this.velocity;this.energy>1&&(this.energy=1);a.DRAWDONE=this.energy===1};this.MarkPoint.prototype.isPointInPath=function(c,e,f){var h,j,l;switch(d){case "column":for(h=0;h<this.parts.length;h++)for(j=0;j<this.parts[h].cubes.length;j++)if(this.parts[h].cubes[j].height>0&&(c.beginPath(),c.moveTo(this.parts[h].cubes[j].vertexs[0][0],this.parts[h].cubes[j].vertexs[0][1]),c.lineTo(this.parts[h].cubes[j].vertexs[1][0],this.parts[h].cubes[j].vertexs[1][1]),
c.lineTo(this.parts[h].cubes[j].vertexs[1][0],this.parts[h].cubes[j].vertexs[1][1]-this.parts[h].cubes[j].height),c.lineTo(this.parts[h].cubes[j].vertexs[3][0],this.parts[h].cubes[j].vertexs[3][1]-this.parts[h].cubes[j].height),c.lineTo(this.parts[h].cubes[j].vertexs[3][0],this.parts[h].cubes[j].vertexs[3][1]),c.isPointInPath(e,f))){a.hoveredMarkPoint=this;this.hActive=h;this.vActive=j;return}break;case "pie":for(h=0;h<1;h++){var s=this.parts[h].tCentrePoint,u=this.parts[h].oUnderPoints,v=this.parts[h].oTopPoints,
y=this.parts[h].iUnderPoints,A=this.parts[h].iTopPoints,C=!1;this.parts[h].size/2>g&&(C=!0);var B=Math.round(25),z=[],w=[],x=[];l=[];for(j=0;j<this.parts[h].sectors.length;j++)z.push(this.parts[h].sectors[j].angle),w.push(this.parts[h].sectors[j].startIndex),x.push(Math.round(this.parts[h].sectors[j].endIndex*this.energy)),l.push(b[j]?b[j]:n.color);for(j=z.length-1;j>=0;j--)if(z[j]>0){c.beginPath();if(w[j]>B){c.moveTo(v[x[j]].get2d().x,v[x[j]].get2d().y);for(l=x[j]-1;l>=w[j];l--)c.lineTo(v[l].get2d().x,
v[l].get2d().y);if(C){c.lineTo(A[w[j]].get2d().x,A[w[j]].get2d().y);for(l=w[j];l<=x[j];l++)c.lineTo(y[l].get2d().x,y[l].get2d().y);c.lineTo(A[x[j]].get2d().x,A[x[j]].get2d().y)}else c.lineTo(s.get2d().x,s.get2d().y)}else if(x[j]<B){c.moveTo(u[x[j]].get2d().x,u[x[j]].get2d().y);for(l=x[j]-1;l>=w[j];l--)c.lineTo(u[l].get2d().x,u[l].get2d().y);c.lineTo(v[w[j]].get2d().x,v[w[j]].get2d().y);if(C)for(l=w[j];l<=x[j];l++)c.lineTo(A[l].get2d().x,A[l].get2d().y);else c.lineTo(s.get2d().x,s.get2d().y);c.lineTo(v[x[j]].get2d().x,
v[x[j]].get2d().y)}else{c.moveTo(v[x[j]].get2d().x,v[x[j]].get2d().y);for(l=x[j]-1;l>=B;l--)c.lineTo(v[l].get2d().x,v[l].get2d().y);for(l=B;l>=w[j];l--)c.lineTo(u[l].get2d().x,u[l].get2d().y);c.lineTo(v[w[j]].get2d().x,v[w[j]].get2d().y);if(C){for(l=w[j];l<=B;l++)c.lineTo(A[l].get2d().x,A[l].get2d().y);for(l=B;l<=x[j];l++)c.lineTo(y[l].get2d().x,y[l].get2d().y)}else c.lineTo(s.get2d().x,s.get2d().y)}if(c.isPointInPath(e,f)){a.hoveredMarkPoint=this;this.hActive=h;this.vActive=j;return}}}}};this.MarkPoint.prototype.draw=
function(c){var e=a._rendererOptions.markPoint.slope;this.update();var f,m,p;p=!1;var q;switch(d){case "column":for(f=0;f<this.parts.length;f++)for(m=0;m<this.parts[f].cubes.length;m++)if(this.parts[f].cubes[m].height>0&&(p=!0,q=b[m]?b[m]:n.color,a.hoveredMarkPoint===this&&f===this.hActive&&m===this.vActive&&(q=GeoGlobe.Util.getShadeColor(q,20)),c.globalAlpha=l,c.globalCompositeOperation="source-over",c.shadowBlur=0,c.shadowOffsetX=0,c.shadowOffsetY=0,c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[0][0],
this.parts[f].cubes[m].vertexs[0][1]),c.lineTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]),c.closePath(),c.fillStyle=q,c.fill(),h!==0))c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]),
c.lineTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]),c.lineTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]-this.parts[f].cubes[m].height*this.energy),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(q,-40),c.fill(),c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]-
this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[2][0],this.parts[f].cubes[m].vertexs[2][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]-this.parts[f].cubes[m].height*this.energy),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(q,-20),c.fill(),c.shadowColor=
n.shadowColor,c.shadowBlur=n.shadowBlur,c.shadowOffsetX=n.shadowOffsetX,c.shadowOffsetY=n.shadowOffsetY,c.globalCompositeOperation="destination-over",c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]),c.lineTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[2][0],this.parts[f].cubes[m].vertexs[2][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[2][0],
this.parts[f].cubes[m].vertexs[2][1]),c.closePath(),c.fillStyle=q,c.fill(),c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[2][0],this.parts[f].cubes[m].vertexs[2][1]),c.lineTo(this.parts[f].cubes[m].vertexs[2][0],this.parts[f].cubes[m].vertexs[2][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]),
c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(q,-40),c.fill(),c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]),c.lineTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]),c.lineTo(this.parts[f].cubes[m].vertexs[2][0],this.parts[f].cubes[m].vertexs[2][1]),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(q,-20),c.fill();if(p)c.lineWidth=
0.3,c.globalAlpha=1,c.globalCompositeOperation="destination-over",c.shadowBlur=0,c.shadowOffsetX=0,c.shadowOffsetY=0,c.strokeStyle="#fff",c.beginPath(),c.moveTo(this.x-this.parts.length/2*g-(this.parts.length/2-0.5)*j-5,this.y),c.lineTo(this.x+this.parts.length/2*g+(this.parts.length/2-0.5)*j+5,this.y),c.closePath(),c.stroke(),h!==0&&(c.beginPath(),c.moveTo(this.x-(h/2+5)*Math.cos(e),this.y+(h/2+5)*Math.sin(e)),c.lineTo(this.x+(h/2+5)*Math.cos(e),this.y-(h/2+5)*Math.sin(e)),c.closePath(),c.stroke());
break;case "pie":c.globalAlpha=l;for(f=0;f<1;f++){q=this.parts[f].uCentrePoint;var s=this.parts[f].tCentrePoint,u=this.parts[f].oUnderPoints,v=this.parts[f].oTopPoints,y=this.parts[f].iUnderPoints,A=this.parts[f].iTopPoints,C=!1;this.parts[f].size/2>g&&(C=!0);var B=Math.round(25),z=[],w=[],x=[],D=[];for(m=0;m<this.parts[f].sectors.length;m++)z.push(this.parts[f].sectors[m].angle),w.push(this.parts[f].sectors[m].startIndex),x.push(Math.round(this.parts[f].sectors[m].endIndex*this.energy)),D.push(b[m]?
b[m]:n.color);for(m=z.length-1;m>=0;m--)z[m]>0&&a.hoveredMarkPoint===this&&f===this.hActive&&m===this.vActive&&(D[m]=GeoGlobe.Util.getShadeColor(D[m],10));for(m=z.length-1;m>=0;m--)if(z[m]>0){c.globalCompositeOperation="destination-over";c.beginPath();c.moveTo(u[x[m]].get2d().x,u[x[m]].get2d().y);for(p=x[m]-1;p>=w[m];p--)c.lineTo(u[p].get2d().x,u[p].get2d().y);if(C)for(p=w[m];p<=x[m];p++)c.lineTo(y[p].get2d().x,y[p].get2d().y);else c.lineTo(q.get2d().x,q.get2d().y);c.fillStyle=D[m];c.fill()}if(e!==
0){for(m=z.length-1;m>=0;m--)if(z[m]>0)c.globalCompositeOperation="source-over",c.beginPath(),c.moveTo(u[x[m]].get2d().x,u[x[m]].get2d().y),C?(c.lineTo(y[x[m]].get2d().x,y[x[m]].get2d().y),c.lineTo(A[x[m]].get2d().x,A[x[m]].get2d().y)):(c.lineTo(q.get2d().x,q.get2d().y),c.lineTo(s.get2d().x,s.get2d().y)),c.lineTo(v[x[m]].get2d().x,v[x[m]].get2d().y),c.moveTo(u[w[m]].get2d().x,u[w[m]].get2d().y),C?(c.lineTo(y[w[m]].get2d().x,y[w[m]].get2d().y),c.lineTo(A[w[m]].get2d().x,A[w[m]].get2d().y)):(c.lineTo(q.get2d().x,
q.get2d().y),c.lineTo(s.get2d().x,s.get2d().y)),c.lineTo(v[w[m]].get2d().x,v[w[m]].get2d().y),c.fillStyle=GeoGlobe.Util.getShadeColor(D[m],-20),c.fill();if(C)for(m=z.length-1;m>=0;m--)if(z[m]>0){c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(y[x[m]].get2d().x,y[x[m]].get2d().y);if(w[m]<B&&x[m]>B){for(p=x[m]-1;p>=B;p--)c.lineTo(y[p].get2d().x,y[p].get2d().y);for(p=B;p<=x[m];p++)c.lineTo(A[p].get2d().x,A[p].get2d().y);c.moveTo(y[w[m]].get2d().x,y[w[m]].get2d().y);for(p=w[m]+1;p<=B;p++)c.lineTo(y[p].get2d().x,
y[p].get2d().y);for(p=B;p>=w[m];p--)c.lineTo(A[p].get2d().x,A[p].get2d().y)}else{for(p=x[m]-1;p>=w[m];p--)c.lineTo(y[p].get2d().x,y[p].get2d().y);for(p=w[m];p<=x[m];p++)c.lineTo(A[p].get2d().x,A[p].get2d().y)}c.fillStyle=GeoGlobe.Util.getShadeColor(D[m],-20);c.fill()}for(m=z.length-1;m>=0;m--)if(z[m]>0){if(w[m]<B&&x[m]>B){c.globalCompositeOperation="destination-over";c.beginPath();c.moveTo(u[x[m]].get2d().x,u[x[m]].get2d().y);for(p=x[m]-1;p>=B;p--)c.lineTo(u[p].get2d().x,u[p].get2d().y);for(p=B;p<=
x[m];p++)c.lineTo(v[p].get2d().x,v[p].get2d().y);c.fillStyle=GeoGlobe.Util.getShadeColor(D[m],-20);c.fill();c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(u[w[m]].get2d().x,u[w[m]].get2d().y);for(p=w[m]+1;p<=B;p++)c.lineTo(u[p].get2d().x,u[p].get2d().y);for(p=B;p>=w[m];p--)c.lineTo(v[p].get2d().x,v[p].get2d().y)}else{c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(u[x[m]].get2d().x,u[x[m]].get2d().y);for(p=x[m]-1;p>=w[m];p--)c.lineTo(u[p].get2d().x,u[p].get2d().y);
for(p=w[m];p<=x[m];p++)c.lineTo(v[p].get2d().x,v[p].get2d().y)}c.fillStyle=GeoGlobe.Util.getShadeColor(D[m],-20);c.fill()}for(m=z.length-1;m>=0;m--)if(z[m]>0){c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(v[x[m]].get2d().x,v[x[m]].get2d().y);for(p=x[m]-1;p>=w[m];p--)c.lineTo(v[p].get2d().x,v[p].get2d().y);if(C)for(p=w[m];p<=x[m];p++)c.lineTo(A[p].get2d().x,A[p].get2d().y);else c.lineTo(s.get2d().x,s.get2d().y);c.fillStyle=D[m];c.fill()}}}}}},_initCanvas:function(){this.canvas=[];
this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height;this.canvas[0].style.position=
"absolute";this._parent.container.appendChild(this.canvas[0]);this.setVisible(this.visibility)},_initTooltip:function(){if((this._rendererOptions.markPoint.hoverable||this._rendererOptions.markPoint.clickable)&&this._rendererOptions.tooltip.show)this.tooltipDiv=this.tooltipDiv||this._parent.container.appendChild(document.createElement("div")),this.tooltipDiv.style.position="absolute",this.tooltipDiv.style.display="none",this.tooltipDiv.style.zIndex=999,this.tooltipDiv.style.width=this._rendererOptions.tooltip.width+
"px",this.tooltipDiv.style.color=this._rendererOptions.tooltip.textStyle.color,this.tooltipDiv.style.padding=this._rendererOptions.tooltip.padding.toString().split(" ").join("px ")+"px",this.tooltipDiv.style.font=this._rendererOptions.tooltip.textStyle.fontStyle+" "+this._rendererOptions.tooltip.textStyle.fontWeight+" "+this._rendererOptions.tooltip.textStyle.fontSize+"px "+this._rendererOptions.tooltip.textStyle.fontFamily,this.tooltipDiv.style["background-color"]=document.createElement("canvas").getContext?
this._rendererOptions.tooltip.backgroundColor:GeoGlobe.Util.getRgbColor(this._rendererOptions.tooltip.backgroundColor),this.tooltipDiv.style["border-width"]=this._rendererOptions.tooltip.borderWidth+"px",this.tooltipDiv.style["border-color"]=this._rendererOptions.tooltip.borderColor,this.tooltipDiv.style["border-radius"]=this._rendererOptions.tooltip.borderRadius+"px",this.tooltipDiv.style["border-style"]="solid",this.tooltipDiv.style["white-space"]="nowrap",this.tooltipDiv.style.transition="left 0.4s, top 0.4s",
this.tooltipDiv.innerHTML='<h3 style="opacity:0.9;margin:0;padding-bottom:8px;border-bottom:1px solid '+this._rendererOptions.tooltip.textStyle.color+';overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><span></span><span style="float: right;"></span></h3><ul style="list-style-type:none;opacity:0.8;margin:0;padding:6px 18px 0 0;"></ul>'},render:function(){this._initCanvas();this._initTooltip();var a,b=this;(function d(){requestAnimationFrame(d);if(b._parent.moving||b.RELOADED||b.RESIZE||
b.SWITCH){b._rendererOptions.markPoint.slope=b._parent.map.getPitch()*Math.PI/180;(b.RELOADED||b.SWITCH)&&b.updateCountValueMinMaxSum();for(a=b.markPoints.length;a--;)b.SWITCH&&b.markPoints[a].init(),!b.SWITCH&&b.markPoints[a].updateXY(),(b.RELOADED||b.SWITCH)&&b.markPoints[a].updateSize(),b.markPoints[a].updatePartXY();b.draw();b.RELOADED&&b.drawLegend();b.RELOADED&&(b.RELOADED=!1);b.RESIZE&&(b.RESIZE=!1);b.SWITCH&&(b.SWITCH=!1)}b.DRAWDONE===!1&&b.draw()})();this.RENDERED=!0},click:function(a){this._rendererOptions.markPoint.clickable&&
this.hoveredMarkPoint&&this._parent.fire("overlayerclick",{layer:this,feature:this.hoveredMarkPoint,event:a})},mouseMove:function(a){this._rendererOptions.markPoint.hoverable&&this.visibility&&this.markPoints.length>0&&!this._parent.map.moving&&(this.hover(a.point.x,a.point.y),this.hoveredMarkPoint&&this._parent.fire("overlayerhover",{layer:this,feature:this.hoveredMarkPoint,event:a}))},resize:function(){this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=
this.cacheCanvas[0].height=this.height=this._parent.map.transform.height;this.RESIZE=!0},draw:function(){this.cacheCanvas[0].width=this.width;for(var a=this.markPoints.length;a--;)this.markPoints[a].draw(this.cacheCanvasContext[0]);this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},drawLegend:function(){if(this._legend&&this._legend.show){if(!this.legendDiv)this.legendDiv=document.createElement("div"),this.legendDiv.style.display=this.visibility?"block":"none",
this.legendDiv.style.zIndex=9999,this.legendDiv.style.position="absolute",this.legendDiv.style["background-color"]=this._legend.backgroundColor,this.legendDiv.style["border-color"]=this._legend.borderColor,this.legendDiv.style["border-width"]=this._legend.borderWidth+"px",this.legendDiv.style["border-radius"]=this._legend.borderRadius+"px",this.legendDiv.style["border-style"]="solid",this.legendDiv.style["box-shadow"]=this._legend.shadowOffsetX+"px "+this._legend.shadowOffsetY+"px "+this._legend.shadowBlur+
"px "+this._legend.shadowColor,this.legendDiv.style.padding=this._legend.padding+"px",this.legendDiv.style.left=this._legend.left!==null?this._legend.left+"px":null,this.legendDiv.style.right=this._legend.right!==null?this._legend.right+"px":null,this.legendDiv.style.top=this._legend.top!==null?this._legend.top+"px":null,this.legendDiv.style.bottom=this._legend.bottom!==null?this._legend.bottom+"px":null,this.legendCanvas=document.createElement("canvas"),this.legendCanvasContext=this.legendCanvas.getContext("2d"),
...
e=this._legend.col,f=0;f<e;f++)c%this._legend.col===f&&(!a[f]||a[f]<b)&&(a[f]=b);for(var g=10,b=10,c=0,d=a.length;c<d;c++)g+=a[c]+10;b+=((this._legend.itemHeight<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemHeight)+10)*(~~(this._legend.vLegendLabels.length/this._legend.col)+(this._legend.vLegendLabels.length%this._legend.col===0?0:1));this.legendCanvas.width=g;this.legendCanvas.height=b;var h=function(b,c,d){this.legendCanvas.width=g;for(var e=!1,f,h,m=0,p=this._legend.vLegendLabels.length;m<
p;m++){h=0;for(var q=this._legend.col;h<q;h++)if(m%this._legend.col===h){f=10+this._legend.itemWidth/2;for(var s=0;s<h;s++)f+=a[s]+10}h=10+this._legend.itemHeight/2+((this._legend.itemHeight<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemHeight)+10)*~~(m/this._legend.col);s=q=!1;this.legendCanvasContext.beginPath();this.legendCanvasContext.rect(f-this._legend.itemWidth/2,h-this._legend.itemHeight/2,this._legend.itemWidth,this._legend.itemHeight);b==="mousemove"&&
c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(e=q=!0);b==="mousedown"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(s=!0);this.legendCanvasContext.beginPath();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.rect(f+this._legend.itemWidth/2+10,h-this._legend.textStyle.fontSize/2,this.legendCanvasContext.measureText(this._legend.vLegendLabels[m].toString()).width,
this._legend.textStyle.fontSize);b==="mousemove"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(e=q=!0);b==="mousedown"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(s=!0);if(s)this._legend.itemStatuses[m]=this._legend.itemStatuses[m]===0?1:0,this.SWITCH=!0;var u=this._legend.itemStatuses[m]===0?"#808080":this._legend.itemColors[m]?this._legend.itemColors[m]:this._rendererOptions.markPoint.itemStyle.color,v=this._legend.itemStatuses[m]===0?"#808080":
this._legend.textStyle.color,u=q||s?GeoGlobe.Util.getShadeColor(u,20):u,v=q||s?GeoGlobe.Util.getShadeColor(v,20):v;this.legendCanvasContext.beginPath();this.legendCanvasContext.rect(f-this._legend.itemWidth/2,h-this._legend.itemHeight/2,this._legend.itemWidth,this._legend.itemHeight);this.legendCanvasContext.fillStyle=u;this.legendCanvasContext.fill();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;
this.legendCanvasContext.textAlign="left";this.legendCanvasContext.textBaseline="middle";this.legendCanvasContext.fillStyle=v;this.legendCanvasContext.fillText(this._legend.vLegendLabels[m],f+this._legend.itemWidth/2+10,h)}this.legendCanvas.style.cursor=e?"pointer":"default"}.bind(this);this.legendCanvas.onmousedown=function(a){var b=a.offsetX||a.clientX-(a.target||a.srcElement).getBoundingClientRect().left,c=a.offsetY||a.clientY-(a.target||a.srcElement).getBoundingClientRect().top;h(a.type,b,c)};
this.legendCanvas.onmousemove=function(a){var b=a.offsetX||a.clientX-(a.target||a.srcElement).getBoundingClientRect().left,c=a.offsetY||a.clientY-(a.target||a.srcElement).getBoundingClientRect().top;h(a.type,b,c)};h()}},updateCountValueMinMaxSum:function(){this.measureValueMinSum=Infinity;this.measureValueMaxSum=-Infinity;var a,b,c,d,e,f,g;a=0;for(d=this.markPoints.length;a<d;a++){this.markPoints[a].measureValueSums=[];b=0;for(e=this.markPoints[a].measureValues.length;b<e;b++){c=g=0;for(f=this.markPoints[a].measureValues[b].length;c<
f;c++)this._legend.itemStatuses[c]!==0&&(g+=this.markPoints[a].measureValues[b][c]);this.markPoints[a].measureValueSums.push(g);g<this.measureValueMinSum&&(this.measureValueMinSum=g);g>this.measureValueMaxSum&&(this.measureValueMaxSum=g)}}},hover:function(a,b){this.lastHoveredMarkPoint=this.hoveredMarkPoint?GeoGlobe.Util.clone(this.hoveredMarkPoint):null;this.hoveredMarkPoint=null;for(var c=0,d=this.markPoints.length;c<d;c++)!this.hoveredMarkPoint&&this.markPoints[c].isPointInPath(this.cacheCanvasContext[0],
a,b);this.draw();this.hoveredMarkPoint?(this.canvas[0].style.cursor="pointer",this.showTooltip(this.hoveredMarkPoint,a,b)):(this.canvas[0].style.cursor="default",this.hideTooltip())},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show){this.tooltipDiv.getElementsByTagName("span")[0].textContent=this._legend.hLegendLabels[a.hActive];this.tooltipDiv.getElementsByTagName("span")[1].textContent=a.name;var d=this.tooltipDiv.getElementsByTagName("ul")[0];d.innerHTML="";for(var e=0;e<this._legend.vLegendLabels.length;e++)this._legend.itemStatuses[e]!==
0&&(d.innerHTML+='<li style="line-height:20px;'+(e===a.vActive?"":"opacity:0.6;")+'"><div style="width: 12px;height: 12px;margin: 5px 5px 0 0;float: left;background-color: '+(this._legend.itemColors[e]?this._legend.itemColors[e]:this._rendererOptions.markPoint.itemStyle.color)+';"></div><span style="font-weight: 600;">'+this._legend.vLegendLabels[e]+"\uff1a</span><span>\u00a5"+a.measureValues[a.hActive][e]+"\u5143</span></li>");this.tooltipDiv.style.top=c-15+"px";this.tooltipDiv.style.left=b+15+"px";
this.tooltipDiv.style.display="block"}},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display="none"},addTo:function(a){this._parent=a;this._parent.addLayer(this)},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=a?"block":"none";this.legendDiv&&(this.legendDiv.style.display=a?"block":"none")},setData:function(a){this.data=a;for(var b=[],c=0;c<a.length;c++){for(var d=[],e=0;e<this._legend.hLegendLabels.length;e++){d[e]=[];for(var f=0;f<this._legend.vLegendLabels.length;f++)d[e][f]=
Number(a[c].properties[this._legend.hLegendLabels[e]][this._legend.vLegendLabels[f]]||0)}b.push(new this.MarkPoint(c,a[c].properties.name,d,a[c].geometry.coordinates[0],a[c].geometry.coordinates[1]))}this.markPoints=b;this.RELOADED=!0}});
GeoGlobe.Visuals.Custom.Voronoi=GeoGlobe.Class4OL({_parent:null,canvas:[],cacheCanvas:[],canvasContext:[],cacheCanvasContext:[],MarkFace:null,markFaces:[],initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this._init_RendererOptions();this._initMarkFace();this._initBounds();this.setData(this.data)},_init_RendererOptions:function(){this._rendererOptions=GeoGlobe.Util.deepExtend({},{markFace:{hoverable:!0,clickable:!0,itemStyle:{color:"rgba(255,0,0,0)",borderColor:"#000",borderWidth:1,
shadowColor:"#000",shadowBlur:0,shadowOffsetX:0,shadowOffsetY:0}},tooltip:{show:!0,backgroundColor:"rgba(0,0,0,0.7)",borderColor:"#333",borderRadius:0,borderWidth:0,padding:5,textStyle:{color:"#fff",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}}},this.rendererOptions)},_initMarkFace:function(){var a=this,b=this._rendererOptions.markFace.itemStyle;if(typeof b.color==="object")var c=GeoGlobe.Util.getGradientImageData(b.color);this.MarkFace=function(a,e,f,g,h,j){this.index=a;
this.name=e;this.value=f;this.lon=g;this.lat=h;this.polygons=j;this.vertices=[];this.color=typeof b.color==="object"?"rgba("+c[parseInt(f*255,10)*4]+","+c[parseInt(f*255,10)*4+1]+","+c[parseInt(f*255,10)*4+2]+","+c[3]/255+")":b.color};this.MarkFace.prototype.updateXY=function(){var b=a._parent.map.project([this.lon,this.lat]);this.x=b.x;this.y=b.y;var c;this.vertices=[];this.polygons.map(function(f){f.geometry.coordinates.map(function(g){c=[];(f.geometry.type==="MultiPolygon"?g[0]:g).map(function(f){b=
a._parent.map.project(f);c.push([b.x,b.y])});this.vertices.push(c)}.bind(this))}.bind(this))};this.MarkFace.prototype.isPointInPath=function(b,c,f){b.beginPath();this.vertices.map(function(a){b.moveTo(a[0][0],a[0][1]);a.map(function(a){b.lineTo(a[0],a[1])})});b.closePath();if(b.isPointInPath(c,f))a.hoveredMarkFace=this};this.MarkFace.prototype.draw=function(c){c.shadowColor=b.shadowColor;c.shadowBlur=b.shadowBlur;c.shadowOffsetX=b.shadowOffsetX;c.shadowOffsetY=b.shadowOffsetY;c.beginPath();this.vertices.map(function(a){c.moveTo(a[0][0],
...
this.response.features[0].geometry.coordinates,d=0;d<b.length;d++)a.bounds.push(turf.polygon(b[d]))}};b.send()},_initCanvas:function(){this.canvas=[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.canvas[0].width=this.cacheCanvas[0].width=this.width=
this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height;this.canvas[0].style.position="absolute";this._parent.container.appendChild(this.canvas[0]);this.setVisible(this.visibility)},_initTooltip:function(){if((this._rendererOptions.markFace.hoverable||this._rendererOptions.markFace.clickable)&&this._rendererOptions.tooltip.show)this.tooltipDiv=this.tooltipDiv||this._parent.container.appendChild(document.createElement("div")),
this.tooltipDiv.style.position="absolute",this.tooltipDiv.style.display="none",this.tooltipDiv.style.zIndex=999,this.tooltipDiv.style.color=this._rendererOptions.tooltip.textStyle.color,this.tooltipDiv.style.padding=this._rendererOptions.tooltip.padding+"px",this.tooltipDiv.style.font=this._rendererOptions.tooltip.textStyle.fontStyle+" "+this._rendererOptions.tooltip.textStyle.fontWeight+" "+this._rendererOptions.tooltip.textStyle.fontSize+"px "+this._rendererOptions.tooltip.textStyle.fontFamily,
this.tooltipDiv.style["background-color"]=document.createElement("canvas").getContext?this._rendererOptions.tooltip.backgroundColor:GeoGlobe.Util.getRgbColor(this._rendererOptions.tooltip.backgroundColor),this.tooltipDiv.style["border-width"]=this._rendererOptions.tooltip.borderWidth+"px",this.tooltipDiv.style["border-color"]=this._rendererOptions.tooltip.borderColor,this.tooltipDiv.style["border-radius"]=this._rendererOptions.tooltip.borderRadius+"px",this.tooltipDiv.style["border-style"]="solid",
this.tooltipDiv.style["white-space"]="nowrap",this.tooltipDiv.style.transition="left 0.4s, top 0.4s"},render:function(){this._initCanvas();this._initTooltip();var a,b=this;(function d(){requestAnimationFrame(d);if(b._parent.moving||b.RELOADED||b.RESIZE){for(a=b.markFaces.length;a--;)b.markFaces[a].updateXY();b.draw();b.RELOADED&&(b.RELOADED=!1);b.RESIZE&&(b.RESIZE=!1)}})();this.RENDERED=!0},click:function(a){this._rendererOptions.markFace.clickable&&this.hoveredMarkFace&&this._parent.fire("overlayerclick",
{layer:this,feature:this.hoveredMarkFace,event:a})},mouseMove:function(a){this._rendererOptions.markFace.hoverable&&this.visibility&&this.markFaces.length>0&&!this._parent.map.moving&&(this.hover(a.point.x,a.point.y),this.hoveredMarkFace&&this._parent.fire("overlayerhover",{layer:this,feature:this.hoveredMarkFace,event:a}))},resize:function(){this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height;
this.RESIZE=!0},draw:function(){this.cacheCanvas[0].width=this.width;for(var a=this.markFaces.length;a--;)this.markFaces[a].draw(this.cacheCanvasContext[0]);this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},hover:function(a,b){this.lastHoveredMarkFace=this.hoveredMarkFace?GeoGlobe.Util.clone(this.hoveredMarkFace):null;this.hoveredMarkFace=null;for(var c=0,d=this.markFaces.length;c<d;c++)!this.hoveredMarkFace&&this.markFaces[c].isPointInPath(this.cacheCanvasContext[0],
a,b);this.draw();this.hoveredMarkFace?(this.canvas[0].style.cursor="pointer",this.showTooltip(this.hoveredMarkFace.name,a,b)):(this.canvas[0].style.cursor="default",this.hideTooltip())},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=a,this.tooltipDiv.style.top=c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display="none"},addTo:function(a){this._parent=
a;this._parent.addLayer(this)},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=a?"block":"none"},getVoronoi:function(a){a=GeoGlobe.Util.clone(a);a.features.map(function(a){a.geometry.coordinates=GeoGlobe.Util.transferToMercator(a.geometry.coordinates)});a=turf.voronoi(a,{bbox:GeoGlobe.Util.transferToMercator([-180,-90]).concat(GeoGlobe.Util.transferToMercator([180,90]))});a=GeoGlobe.Util.clone(a);a.features.map(function(a){a.geometry.coordinates[0].map(function(c,d){a.geometry.coordinates[0][d]=
GeoGlobe.Util.transferToLonLat(c)})});return a},setData:function(a){this.data=a;var b=this,c=setInterval(function(){if(b.bounds){clearInterval(c);b.markFaces=[];b.hoveredMarkFace=null;for(var d=b.getVoronoi(a).features,e=b.bounds,f,g,h=0;h<d.length;h++){f=[];for(var j=0;j<e.length;j++)(g=turf.intersect(d[h],e[j]))&&f.push(g);b.markFaces.push(new b.MarkFace(h,a.features[h].properties.name,Math.random(),a.features[h].geometry.coordinates[0],a.features[h].geometry.coordinates[1],f))}b.RELOADED=!0}},
1)}});
GeoGlobe.Visuals.MapV=GeoGlobe.Class4OL(GeoGlobe.Visuals,{map:null,container:null,layers:[],initialize:function(){GeoGlobe.Visuals.prototype.initialize.apply(this,arguments);window.mapv||console.error("\u4f7f\u7528MapV\u53ef\u89c6\u5316\u56fe\u5c42\u524d\uff0c\u9700\u5f15\u5165mapv\u5e93\uff01")},addTo:function(){GeoGlobe.Visuals.prototype.addTo.apply(this,arguments);this.container.className="geoglobe-mapv-container"},render:function(){for(var a=0;a<this.layers.length;a++)this.layers[a].render()},addLayer:function(a){a.id?
this.getLayer(a.id)||this.layers.push(a):console.error("\u56fe\u5c42id\u5c5e\u6027\u4e0d\u80fd\u4e3a\u7a7a\uff01")},removeLayer:function(a){for(var b=[],c=0;c<this.layers.length;c++)a!==this.layers[c].id&&b.push(this.layers[c]);this.layers=b},getLayer:function(a){for(var b=0;b<this.layers.length;b++)if(a===this.layers[b].id)return this.layers[b]}});
GeoGlobe.Visuals.MapV.Simple=GeoGlobe.Class4OL({_parent:null,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this,b=this._parent.map,c=new mapv.DataSet(this.data),d=this.rendererOptions;d.draw="simple";d.dragdrawing=this.dragdrawing;d.container=this._parent.container;d.methods={};d.methods.click=function(b,c){b&&a._parent.fire("overlayerclick",
{layer:a,feature:b,event:c})};d.methods.mousemove=function(b,c){b&&a._parent.fire("overlayerhover",{layer:a,feature:b,event:c})};this._layer=new mapv.mapboxGLMapLayer(b,c,d)},setData:function(a){this.data=a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
