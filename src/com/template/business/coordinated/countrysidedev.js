 ...
 * @desc:农村人居环境
 * @Author: lujing 
 * @Date: 2018-05-31 11:43:48 
 * @Last Modified by: lujing
 * @Last Modified time: 2018-06-26 18:34:35
 */
...
const handle = function(_attr, _slots, _events) {
    ...
    let template = `<countryside-dev @callback="bindEvent" @count="count" ${stringAttr}>${subContent}</countryside-dev>`;
