<!--分享页面-->
<template>
    <div ref="camera" :style="previewStyle">
...
<script>
    ...
    import {historiLoad,historiVerifyPwd,historiConfig,historiComs} from '@/api/share'
    ...
    export default {
        ...
        methods: {
            ...
            VerifyInfo(){
                historiLoad({id:this.code}).then(resp=>{                                     
                    if(resp.resCode===0){
                        if(resp.data===null){                            
            ...
            verifyPwd(){
                ...
                historiVerifyPwd({id:this.code,pwd:this.verfiyCode}).then(resp=>{
                    if(resp.resCode===0){
                        if(resp.data===0){
                            this.$Message.error("密码不正确")
                            return;
