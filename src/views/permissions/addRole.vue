    ...
    <div class="list">      
        ...
        <div class="inputBox">
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" label-position="top" style="width:90%"> 
                ...
                <Row>
                    <Col offset="6">
                        <FormItem label="权限选择" prop="modules">
                            <Tree ref="tree" :data='permissList' show-checkbox style="width:350px;height:380px;overflow:auto">123</Tree> 
                        </FormItem>
                    </Col>
                ...
                <Row>
                    <Col offset="10">
                        <FormItem>
                            <Button type="primary" @click="handleSubmit('formValidate')" size="large">新建</Button>
...
<script>
    import {getModuleTree, addRole} from '../../api/permission'
    export default {
        data () {
            return {
                formValidate: {
        ...
        methods: {
            handleSubmit(name) {
                this.$nextTick(() => {
                    ...
                    this.$refs[name].validate().then(resp => {
                        console.log(resp)
                        if (resp) {
                            console.log(this.formValidate.modules)
                            this.addRole();   
                        } else {
            ...
            getSelectModule() {
                ...
                this.formValidate.modules = modules.join(',');
            },
            addRole() {
                addRole({
